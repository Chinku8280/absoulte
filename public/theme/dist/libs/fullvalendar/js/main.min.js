...
var FullCalendar = function(e) {
	...
	var da = function(e) {
		...
		return n(t, e), t.prototype.render = function() {
			for (var e, t = this.props, n = this.state, r = this.context, i = t.sections || [], a = this.processCols(t.cols), s = this.renderMicroColGroup(a, n.shrinkWidth), l = aa(t.liquid, r), u = i.length, c = 0, d = [], p = [], f = []; c < u && "header" === (e = i[c]).type;) d.push(this.renderSection(e, s)), c += 1;
		...
		Ls = function(e) {
			...
			return n(t, e), t.prototype.render = function() {
				...
				var e, t = this.context,
					n = this.props;
				n.onCoords && null !== n.clientWidth && (this.rootElRef.current.offsetHeight && n.onCoords(new Ws(new Ur(this.rootElRef.current, (e = this.slatElRefs.currentMap, n.slatMetas.map((function(t) {
					return e[t.key]
	...
	var Dl, wl = yo({
			...
			viewContainerAppends: [function(e) {
				...
				if (!/\w+:\/\/fullcalendar\.io\/|\/examples\/[\w-]+\.html$/.test(n)) {
					var r = function(e) {
						if (-1 !== bl.indexOf(e)) return "valid";
						var t = (e || "").match(/^(\d+)-fcs-(\d+)$/);
						if (t && 10 === t[1].length) {
							var n = new Date(1e3 * parseInt(t[2], 10)),
								r = new Date(Di.mockSchedulerReleaseDate || "2021-01-16");
							if (_e(r)) return ye(r, -372) < n ? "valid" : "outdated"
						}
						return "invalid"
					}(t);
					if ("valid" !== r) return Gr("div", {
						className: "fc-license-message",
						style: Rl
					}, "outdated" === r ? Gr(Zr, null, "Your license key is too old to work with this version. ", Gr("a", {
						href: "http://fullcalendar.io/docs/schedulerLicenseKey#outdated"
					}, "More Info")) : Gr(Zr, null, "Your license key is invalid. ", Gr("a", {
	...
	var Il = "undefined" != typeof navigator && /Edge/.test(navigator.userAgent),
		_l = function() {
			function e(e, t) {
				var n = this;
	...
	}, e.sortEventSegs = Rn, e.startOfDay = we, e.translateRect = vr, e.triggerDateSelect = Ln, e.unmountComponentAtNode = Jr, e.unpromisify = Ar, e.version = "5.5.1", e.whenTransitionDone = Q, e.wholeDivideDurations = it, Object.defineProperty(e, "__esModule", {
		value: !0
	}), e
}({});