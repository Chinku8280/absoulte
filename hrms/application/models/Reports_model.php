...
class Reports_model extends CI_Model {
	...
	public function get_leave_report_application_filter_list($year,$user_id,$company_id) {
		
		$sql = 'SELECT * from `xin_leave_applications` where company_id = ? and employee_id = ? and  year(STR_TO_DATE(from_date,"%d-%m-%Y")) = ?  group by employee_id';
		$binds = array($company_id,$user_id,$year);
		$query = $this->db->query($sql, $binds);
		return $query;
	}
