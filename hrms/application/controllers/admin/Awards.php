...
class Awards extends MY_Controller {
    ...
    public function award_list()
     {
		...
		// // print_r($d);
		// $get_month = date('F', mktime(0, 0, 0, (int)$d[0], 10));
		// $award_date = $get_month.', '.$d[0];

		$inputDate = $r->award_month_year;
		// Convert to "F Y" format
		$award_date = date("F Y", strtotime($inputDate));
	...
	public function add_award() {
		...
		// 	$Return['error'] = 'Please Enter Cash';
		// }
