...
class Employee_exit extends MY_Controller {
	...
	public function add_exit() {
		...
		$u_data = array(
			...
			'status'=>$this->input->post('is_inactivate_account')
		);
		$this->Employee_exit_model->update_employee_status($this->input->post('employee_id'),$u_data);
		if ($result == TRUE) {
	...
	public function update() {
		...
		$read = $this->Employee_exit_model->read_exit_information($id);	
		$u_data = array(
			'date_of_leaving'=> $this->input->post('exit_date'),
			'status'=>$this->input->post('is_inactivate_account')
		);
	...
	public function delete() {
		...
		$this->Employee_exit_model->update_employee_status($read[0]->employee_id,$data);
