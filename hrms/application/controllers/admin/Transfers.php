...
class Transfers extends MY_Controller {
	 ...
	 public function read()
	{
		...
		$data = array(
				...
				'transfer_sub_department' => $result[0]->transfer_sub_department,
				...
				'all_sub_department' => $this->Department_model->get_sub_departments()
				);
		if(!empty($session)){ 
	...
	public function add_transfer() {
		...
		'transfer_sub_department' => $this->input->post('transfer_subdepartment'),
		'transfer_designation' => $this->input->post('designation_id'),
	...
	public function update() {
		...
		'transfer_date' => $this->input->post('transfer_date'),
		'transfer_department' => $this->input->post('transfer_department'),
		'transfer_sub_department' => $this->input->post('edit_transfer_subdepartment'),
		'transfer_designation' => $this->input->post('designation_id'),
		'description' => $qt_description,
		'transfer_location' => $this->input->post('transfer_location'),
	...
	public function get_sub_departments() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("admin/transfers/get_sub_departments", $data);
		} else {
			redirect('admin/');
		}
		// Datatables Variables
	 ...
	 public function get_edit_sub_departments() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("admin/transfers/get_edit_sub_departments", $data);
		} else {
			redirect('admin/');
		}
		// Datatables Variables
