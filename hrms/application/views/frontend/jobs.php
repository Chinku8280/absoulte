...
<body>
                ...
                <div class="navs">
                    <ul class="nav navbar-nav account">
                        <li>
                            ...
                            <a href="<?php echo site_url('hr/logout');?>"><i
                                    class="md-lock-open m-r-10"></i><?php echo $this->lang->line('left_logout');?></a>
                            <?php else:?>
                            <a href="<?php echo site_url('admin/logout');?>"><i
                                    class="md-lock-open m-r-10"></i><?php echo $this->lang->line('left_logout');?></a>
                            <?php endif;?>
                        </li>
                    </ul>
                    ...
                    <ul class="nav navbar-nav">
                        <?php if(!empty($esession)):?>
                        <li> <a
                                href="<?php echo site_url('hr/dashboard');?>"><?php echo $this->lang->line('xin_my_dashboard');?></a>
                        </li>
                        <li> <a
                                href="<?php echo site_url('hr/user/jobs_applied');?>"><?php echo $this->lang->line('left_jobs_applied');?></a>
                        </li>
                        <li> <a
                                href="<?php echo site_url('frontend/jobs');?>"><?php echo $this->lang->line('xin_jobs_list');?></a>
                        </li>
                        <?php else:?>
                        <li> <a
                                href="<?php echo site_url('admin/dashboard');?>"><?php echo $this->lang->line('xin_my_dashboard');?></a>
                        </li>
                        <li> <a
                                href="<?php echo site_url('frontend/jobs');?>"><?php echo $this->lang->line('xin_jobs_list');?></a>
                        </li>
    ...
    <section class="page-header lighten-4"
        style="background: url(<?php echo base_url();?>skin/vendor/jobs/assets/images/cover-2.jpg)">
        <div class="container">
                ...
                <div class="card-body">
                  ...
                  ?>
                    <div class="item-jobpost">
                        <div class="row">
                            <div class="col-md-5">
                                <h5> <a href="<?php echo site_url();?>frontend/jobs/detail/<?php echo $job->job_id;?>/">
                                        <?php echo $job->job_title;?></a> </h5>
                                <ul class="list-inline">
                                    <li><?php echo date("j", strtotime($job->created_at));?>
                                        <span><?php echo date("M", strtotime($job->created_at));?></span></li>
                                    <li>
                                        <label class="label bg-green lighten-1"><?php echo $jt_type;?></label>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-md-5 jobpost-location"> <span><?php echo $designation_name;?> >
                                    <?php echo $department_name;?></span> </div>
                            <div class="col-md-2 jobpost-apply-btn"> <a
                                    href="<?php echo site_url();?>frontend/jobs/detail/<?php echo $job->job_id;?>/"
                                    class="btn btn-primary btn-block btn-outline btn-sm"><?php echo $this->lang->line('xin_apply_for_this_job');?>
                                    <i class="md-long-arrow-right m-l-10"></i></a> </div>
                        </div>
                    </div>
                    <?php } ?>
                </div>
