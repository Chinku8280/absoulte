...
*/
	...
	<div class="box <?php echo $get_animate; ?>">
				...
				<table class="datatables-demo table table-striped  table-bordered" id="xin_table_bulk">
					<thead>
						<tr>
							...
							<th><?php echo $this->lang->line('xin_name'); ?> </th>
							<th><?php echo $this->lang->line('xin_salary_type'); ?></th>
							<th>Basic<?php echo $this->lang->line('xin_salary_title'); ?> <input type="checkbox" data-type="basic_salary" class="header_input_bulk"></th>
							<th>RestDay Pay <input type="checkbox" data-type="restday_pay" class="header_input_bulk"></th>
							<th>Total Overtime <input type="checkbox" data-type="all_overtime_P" class="header_input_bulk"></th>
							<th>Commissions <input type="checkbox" data-type="commission" class="header_input_bulk"></th>
							<th>ShareOptions Amount <input type="checkbox" data-type="share_options_amount" class="header_input_bulk"></th>
							<th>Other Payment <input type="checkbox" data-type="other_payments_amount" class="header_input_bulk"> </th>
							<th>Total Allowance <input type="checkbox" data-type="allowance_amount" class="header_input_bulk"></th>
							<th>Leave Deductions <input type="checkbox" data-type="unpaid_leave_amount" class="header_input_bulk"></th>
							<th>TotalLoan <input type="checkbox" data-type="loan_de_amount" class="header_input_bulk"></th>
							<th>Statutory deductions <input type="checkbox" data-type="statutory_deductions_amount" class="header_input_bulk"></th>
							<th>Deduction Amount <input type="checkbox" data-type="total_deduction" class="header_input_bulk"></th>
		...
		<div class="box-body" id="bulk_submit_div_id" style="display: none;">
			<button class="btn btn-light" type="button" id="bulk_submit_btn_id">Submit</button>
		</div>
		<div class="box-body" id="bulk_submit_div_id_advance" style="display: none;">
			<button class="btn btn-light" type="button" id="bulk_submit_btn_id_ad">Submit</button>
		</div>
	</div>
	<style type="text/css">
		...
		<div class="modal-content">
			<form id="uploadForm_hrms">
						...
						<div class="row">
							<div class="col-md-2">
								...
								<div class="form-group">
									...
									<input class="form-control month_year" placeholder="<?php echo $this->lang->line('xin_select_month'); ?>" name="month_year" type="text" id="m_date_month" value="<?php echo date('m-Y', strtotime('-1 month')); ?>">
									<input type="hidden" name="mode_of_pay">
								</div>
							</div>
							<div class="col-md-2">
							<input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>" />
								...
								<div class="form-group">
									...
									<select class="form-control" name="Choose_Banck" id="Choose_Banck">
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn btn-danger" id="uploadBtn">Submit</button>
				</div>
			</form>
