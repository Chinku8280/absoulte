										...
										<tbody>
											<tr>
												<td><strong><?php echo $this->lang->line('xin_payroll_hourly_rate'); ?>:</strong>
													<span class="pull-right"><?php echo $this->Xin_model->currency_sign($hourly_rate); ?></span>
												</td>
											</tr>
											<tr>
											...
											<?php $etotal_count = $pcount * $hourly_rate; ?>
											<tr>
												<td><strong><?php echo $this->lang->line('xin_acc_total'); ?>:</strong>
													<span class="pull-right"><?php echo $this->Xin_model->currency_sign($etotal_count); ?></span>
												</td>
											</tr>
										</tbody>
									</table>
							...
							<table class="datatables-demo table table-striped table-bordered dataTable no-footer">
								<tbody>
									...
									<?php if ($total_loan != 0 || $total_loan != '') : ?>
										<tr>
											<td><strong><?php echo $this->lang->line('xin_payroll_total_loan'); ?>:</strong>
												<span class="pull-right"><?php echo $this->Xin_model->currency_sign(number_format(floatval($total_loan), 2)); ?></span>
											</td>
										</tr>
									<?php endif; ?>
									...
									<?php if ($net_salary != 0 || $net_salary != '') : ?>
										...
										if ($pcount > 0) {
											$total_count = $pcount * $hourly_rate;
											$fsalary = $total_count + $total_net_salary;
										} else {
											$fsalary = $fsalary;
										}
										$total_net_salary = $fsalary;
										?>
										<tr>
											<td><strong><?php echo $this->lang->line('xin_paid_amount'); ?>:</strong> <span class="pull-right">
													<?php echo $this->Xin_model->currency_sign($total_net_salary); ?></span></td>
										</tr>
									<?php endif; ?>
