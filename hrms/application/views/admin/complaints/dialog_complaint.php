            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="<?php echo $this->lang->line('xin_complaint_title');?>"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control d_date"
                            placeholder="<?php echo $this->lang->line('xin_complaint_date');?>" readonly
                            name="complaint_date" type="text" value="<?php echo $complaint_date;?>">
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <table class="footable-details table table-striped table-hover toggle-circle">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="display: table-cell;"><?php echo $this->Xin_model->set_date_format($complaint_date);?>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="display: table-cell;"><?php if($attachment!='' && $attachment!='no file') {?>
                        <img src="<?php echo base_url().'uploads/complaints/'.$attachment;?>" width="70px"
                            id="u_file">&nbsp; <a
                            href="<?php echo site_url()?>admin/download?type=complaints&filename=<?php echo $attachment;?>"><?php echo $this->lang->line('xin_download');?></a>
                        <?php } ?>
                    </td>
                </tr>
                <tr>
