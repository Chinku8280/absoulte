    ...
    <div id="accordion">
        <div class="box-header  with-border">
            <h3 class="box-title"><?php echo $this->lang->line('xin_add_new');?>
                <?php echo $this->lang->line('xin_complaint');?></h3>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group" id="employee_ajax">
                                    <label for="employee"><?php echo $this->lang->line('xin_complaint_from');?><i
                                            class="hrsale-asterisk">*</i></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="title"><?php echo $this->lang->line('xin_complaint_title');?><i
                                                    class="hrsale-asterisk">*</i></label>
                                            <input class="form-control"
                                                placeholder="<?php echo $this->lang->line('xin_complaint_title');?>"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label
                                                for="complaint_date"><?php echo $this->lang->line('xin_complaint_date');?><i
                                                    class="hrsale-asterisk">*</i></label>
                                            <input class="form-control date"
                                                placeholder="<?php echo $this->lang->line('xin_complaint_date');?>"
                                                readonly name="complaint_date" type="text">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group" id="complaint_employee_ajax">
                                            <label
                                                for="complaint_against"><?php echo $this->lang->line('xin_complaint_against');?><i
                                                    class="hrsale-asterisk">*</i></label>
                                            <select multiple class="select2" data-plugin="select_hrm"
                                                data-placeholder="<?php echo $this->lang->line('xin_complaint_employees');?>"
            ...
            <table class="datatables-demo table table-striped table-bordered" id="xin_table">
                <thead>
                    <tr>
                        ...
                        <th width="280"><i class="fa fa-user"></i> <?php echo $this->lang->line('xin_complaint_from');?>
                        </th>
