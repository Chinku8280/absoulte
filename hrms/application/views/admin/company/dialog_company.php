...
?>
    ...
    <div class="modal-body">
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6">
                            <label for="email"><?php echo $this->lang->line('xin_company_type'); ?><i class="hrsale-asterisk">*</i></label>
                            <select class="form-control" name="company_type" data-plugin="select_hrm"
                                data-placeholder="<?php echo $this->lang->line('xin_company_type'); ?>">
                                <option value=""><?php echo $this->lang->line('xin_select_one'); ?></option>
                                <?php foreach ($get_company_types as $ctype) { ?>
                                    <option value="<?php echo $ctype->type_id; ?>" <?php if ($type_id == $ctype->type_id) { ?>
                                        selected="selected" <?php } ?>> <?php echo $ctype->name; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label for="trading_name"><?php echo $this->lang->line('xin_company_trading'); ?></label>
                            <input class="form-control" placeholder="<?php echo $this->lang->line('xin_company_trading'); ?>"
                                name="trading_name" type="text" value="<?php echo $trading_name; ?>">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input class="form-control"
                                placeholder="<?php echo $this->lang->line('xin_company_registration'); ?>"
                                name="registration_no" type="text" value="<?php echo $registration_no; ?>">
                        </div>
                        <div class="col-md-6">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="<?php echo $this->lang->line('xin_gtax'); ?>" name="xin_gtax"
                        value="<?php echo $government_tax; ?>" type="text">
                </div>
                <div class="form-group">
                    <label for="address"><?php echo $this->lang->line('xin_address'); ?><i class="hrsale-asterisk">*</i></label>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <input class="form-control" placeholder="<?php echo $this->lang->line('dashboard_username'); ?>"
                    name="username" type="text" value="<?php echo $username; ?>">
            </div>
            <div class="col-md-5">
                <fieldset class="form-group">
                    <label for="logo"><?php echo $this->lang->line('xin_company_logo'); ?><i class="hrsale-asterisk">*</i></label>
            ...
            <div class="col-md-3">
                <?php if ($logo != '' || $logo != 'no-file') { ?>
                    <span class="avatar box-48 mr-0-5"> <img class="d-block ui-w-100 rounded-circle" width="50"
                            src="<?php echo base_url(); ?>uploads/company/<?php echo $logo; ?>" alt=""> </span>
                <?php } ?>
            </div>
        </div>
        <?php if (!empty($bank_details)) {
            foreach (json_decode($bank_details) as $key => $details) {
        ?>
                <div class="row edit_bank_section">
                    <div class="edit_show_section">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="email">Bank Name
                                </label>
                                <input type="text" name="bank_name[]" class="form-control" value="<?php echo $details->bank_name; ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="bank_account_number[]" class="form-control" value="<?php echo $details->bank_account_number; ?>">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="bank_code[]" class="form-control" value="<?php echo $details->bank_code; ?>">
                            </div>
                        </div>
                        ...
                        <!-- <div class="col-md-2" style="margin-top: 22px;">
                            <div class="form-group">
                                <button type="button"
                                    class="btn icon-btn  btn-success waves-effect waves-light edit_new_section">Add New
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    <label for="email"><?php echo $this->lang->line('xin_invoice_currency'); ?><i class="hrsale-asterisk">*</i></label>
                    <select class="form-control" name="default_currency" data-plugin="select_hrm"
                        data-placeholder="<?php echo $this->lang->line('xin_invoice_currency'); ?>">
                        <option value=""><?php echo $this->lang->line('xin_select_one'); ?></option>
                        <?php foreach ($this->Xin_model->get_currencies() as $currency) { ?>
                            <?php $_currency = $currency->code . ' - ' . $currency->symbol; ?>
                            <option value="<?php echo $_currency; ?>" <?php if ($idefault_currency == $_currency): ?> selected
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label for="phone"><?php echo $this->lang->line('xin_setting_timezone'); ?><i class="hrsale-asterisk">*</i></label>
                    <select class="form-control" name="default_timezone" data-plugin="select_hrm"
                        data-placeholder="<?php echo $this->lang->line('xin_setting_timezone'); ?>">
                        <option value=""><?php echo $this->lang->line('xin_select_one'); ?></option>
                        <?php foreach ($this->Xin_model->all_timezones() as $tval => $labels): ?>
                            <option value="<?php echo $tval; ?>" <?php if ($idefault_timezone == $tval): ?> selected <?php endif; ?>>
                                <?php echo $labels; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
                ...
                <?php if ($mattribute->attribute_type == 'date') { ?>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control d_date" placeholder="<?php echo $mattribute->attribute_label; ?>"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.edit_new_section').click(function() {

                $('.edit_bank_section').append(` <div class="edit_show_section"><div class="col-md-4">
                                <div class="form-group">
                                    <label for="email">Bank Name
                                    </label>
                                    <input type="text" name="bank_name[]" class="form-control">
                ...
                $('.delete_new_section').click(function() {
                    $(this).closest('.edit_show_section').remove();
                })
...
?>
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="edit-modal-data"><i class="icon-eye4"></i>
            <?php echo $this->lang->line('xin_view_company'); ?></h4>
    </div>
    <form class="m-b-1">
        <div class="modal-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="display: table-cell;"><?php if ($logo != '' || $logo != 'no-file') { ?>
                                    <div class="avatar box-48 mr-0-5"> <img class="d-block ui-w-100 rounded-circle"
                                            src="<?php echo base_url(); ?>uploads/company/<?php echo $logo; ?>" alt=""
                                            width="50"></a> </div>
                                <?php } ?>
                            </td>
                        </tr>
