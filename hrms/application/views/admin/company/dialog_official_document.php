                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <fieldset class="form-group">
                                    <label
                                        for="scan_file"><?php echo $this->lang->line('xin_hr_official_license_scan');?></label>
            ...
            <div class="col-md-6">
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="document_type_id" id="document_type_id" class="form-control"
                                ...
                                <option value="<?php echo $document_type->document_type_id;?>"
                                    <?php if($document_type_id==$document_type->document_type_id):?> selected="selected"
                                    <?php endif?>> <?php echo $document_type->document_type;?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label
                                for="license_number"><?php echo $this->lang->line('xin_hr_official_license_number');?></label>
                            <input class="form-control"
...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="edit-modal-data"><i class="icon-eye4"></i>
        <?php echo $this->lang->line('xin_hr_official_document_view');?></h4>
</div>
<form class="m-b-1">
    <div class="modal-body">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="display: table-cell;"><?php foreach($all_document_types as $document_type) {?>
                            <?php if($document_type_id==$document_type->document_type_id):?><?php echo $document_type->document_type;?><?php endif?><?php } ?>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="display: table-cell;"><?php if($document!='' || $document!='no-file'){?>
                            <div class="avatar box-48 mr-0-5">
                                <?php echo $doc = '<a href="'.site_url('admin/download?type=company/official_documents&filename=').$document.'">'.$this->lang->line('xin_view').'</a>';?>
                            </div>
                            <?php } ?>
                        </td>
                    </tr>
