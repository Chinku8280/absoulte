                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label
                                    for="license_name"><?php echo $this->lang->line('xin_hr_official_license_name');?>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label for="company_id"><?php echo $this->lang->line('left_company');?>
                                            <i class="hrsale-asterisk">*</i>
                                        </label>
                                    ...
                                    <?php } ?>
                                    <div class="col-md-6">
                                        <label for="expiry_date"><?php echo $this->lang->line('xin_expiry_date');?>
                                            <i class="hrsale-asterisk">*</i>
                                        </label>
                                        <input class="form-control date"
                                            placeholder="<?php echo $this->lang->line('xin_expiry_date');?>"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <fieldset class="form-group">
                                                <label
                                                    for="scan_file"><?php echo $this->lang->line('xin_hr_official_license_scan');?>
                                                    <i class="hrsale-asterisk">*</i>
                                                </label>
                                                <input type="file" class="form-control-file" id="scan_file"
                                                    name="scan_file">
                                                <small>Upload files
                                                    only:('png','jpg','jpeg','gif','pdf','doc','docx','xls','xlsx')</small>
                                            </fieldset>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="relation"><?php echo $this->lang->line('xin_e_details_dtype');?>
                                            <i class="hrsale-asterisk">*</i>
                                        </label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label
                                            for="license_number"><?php echo $this->lang->line('xin_hr_official_license_number');?>
                                            <i class="hrsale-asterisk">*</i>
                                        </label>
                                        <input class="form-control"
                            ...
                            <div class="form-group">
                                <label
                                    for="xin_gtax"><?php echo $this->lang->line('xin_hr_official_license_alarm');?></label>
                                <select class="form-control" name="license_notification" data-plugin="xin_select"
                                    ...
                                    <option value="0"><?php echo $this->lang->line('xin_hr_license_no_alarm');?>
                                    </option>
