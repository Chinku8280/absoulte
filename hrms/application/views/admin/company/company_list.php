        ...
        <div id="accordion">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo $this->lang->line('xin_add_new'); ?>
                    <?php echo $this->lang->line('module_company_title'); ?></h3>
            ...
            <div id="add_form" class="collapse add-form <?php echo $get_animate; ?>" data-parent="#accordion" style="">
                <div class="box-body">
                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control"
                                        placeholder="<?php echo $this->lang->line('xin_company_name'); ?>" name="name"
                                        type="text">
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="email"><?php echo $this->lang->line('xin_company_type'); ?>
                                                <i class="hrsale-asterisk">*</i>
                                            </label>
                                            <select class="form-control" name="company_type" data-plugin="xin_select"
                                                ...
                                                <?php foreach ($get_company_types as $ctype) { ?>
                                                    <option value="<?php echo $ctype->type_id; ?>"> <?php echo $ctype->name; ?>
                                                    </option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="trading_name"><?php echo $this->lang->line('xin_company_trading'); ?>
                                            </label>
                                            <input class="form-control"
                                                placeholder="<?php echo $this->lang->line('xin_company_trading'); ?>"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <!-- <div class="col-md-6">
                                        <label
                                            for="registration_no"><?php echo $this->lang->line('xin_company_registration'); ?></label>
                                        <input class="form-control"
                                        ...
                                        <div class="col-md-6">
                                            <label
                                                for="contact_number"><?php echo $this->lang->line('xin_contact_number'); ?>
                                                <!-- <i class="hrsale-asterisk">*</i> -->
                                            </label>
                                            <input class="form-control"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <label for="website"><?php echo $this->lang->line('xin_website'); ?>
                                                <!-- <i class="hrsale-asterisk">*</i> -->
                                            </label>
                                            <input class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder=" Tax Number / UEN"
                                        name="xin_gtax" type="text">
                                </div>
                                <div class="form-group">
                                    <label for="address"><?php echo $this->lang->line('xin_address'); ?>
                                        <i class="hrsale-asterisk">*</i>
                                    </label>
                                    <input class="form-control"
                        ...
                        <div class="row">
                            <!-- <div class="col-md-3">
                            <label for="email"><?php echo $this->lang->line('dashboard_username'); ?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
                            <input class="form-control"
                                placeholder="<?php echo $this->lang->line('dashboard_username'); ?>" name="username"
                                type="text">
                        </div> -->
                            <!-- <div class="col-md-3">
                            <label for="website"><?php echo $this->lang->line('xin_employee_password'); ?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
                            <input class="form-control"
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    <label for="logo"><?php echo $this->lang->line('xin_company_logo'); ?>
                                        <i class="hrsale-asterisk">*</i>
                                    </label>
                        ...
                        <div class="row bank_section">
                            <div class="show_section">
                                ...
                                <div class="col-md-2" style="margin-top: 22px;">
                                    <div class="form-group">
                                        <button type="button"
                                            class="btn icon-btn  btn-success waves-effect waves-light add_new_section">Add New
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="email"><?php echo $this->lang->line('xin_invoice_currency'); ?>
                                        <i class="hrsale-asterisk">*</i>
                                    </label>
                                    <select class="form-control" name="default_currency" data-plugin="xin_select"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="default_timezone" data-plugin="xin_select"
...
<div class="box <?php echo $get_animate; ?>">
    <div class="box-header with-border">
        <h3 class="box-title"> <?php echo $this->lang->line('xin_list_all'); ?>
            <?php echo $this->lang->line('xin_companies'); ?> </h3>
    </div>
    <div class="box-body">
