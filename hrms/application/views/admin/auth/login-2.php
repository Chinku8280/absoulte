                    ...
                    <div class="authfy-login">
                        ...
                        <div class="authfy-panel panel-login text-center active">
                            <div class="authfy-heading">
                                <h3 class="auth-title">
                                    <?php echo $this->lang->line('xin_hrsale_login_to_your_account');?></h3>
                            </div>
                            <div class="row">
					...
					'data-form-table' => 'login', 'data-is-redirect' => '1', 'autocomplete' => 'off');?>
						...
						if($system[0]->employee_login_id=='username'):
                            ...
                            <!-- <div class="row">
                                <div class="col-md-4">
                                    <div class="btn-group">
                                        <button type="button" class="btn bg-purple btn-flat btn-sm"
                                            data-toggle="dropdown" aria-expanded="false">Login as</button>
                                        <button type="button" class="btn bg-purple btn-flat btn-sm dropdown-toggle"
                                            ...
                                            <span class="sr-only">Login as</span> </button>
