...
<head>
    ...
    <link media="all" type="text/css" rel="stylesheet"
        href="<?php echo base_url();?>skin/hrsale_assets/css/hrsale/xin_login_2.css">
	...
	if($system[0]->employee_login_id=='username'):
		...
		$ilogn_info2 = 'jsmt12@hrsale.com';
            ...
            <div class="row">
                ...
                <div class="col-xs-8 m-t-20"> <a href="<?php echo site_url('admin/auth/forgot_password');?>"
            ...
            <!-- <div class="row">
                <div class="col-xs-8">
                    <div class="btn-group">
                        <button type="button" class="btn btn-default btn-sm" data-toggle="dropdown"
                            aria-expanded="false">Login With</button>
                        <button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown"
                            aria-expanded="false"> <span class="caret"></span> <span class="sr-only">Login With</span>
                        </button>
                ...
                <div class="col-xs-4">
                    <button type="button" class="btn btn-success btn-block btn-flat btn-sm"
                        onClick="window.location='<?php echo site_url('client/');?>'">Client Panel </button>
                </div>
