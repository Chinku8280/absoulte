...
<head>
    ...
    <link media="all" type="text/css" rel="stylesheet"
        href="<?php echo base_url();?>skin/hrsale_assets/css/hrsale/animate.css">
...
<body class="hold-transition login-page" <?php echo $auth_bg;?>>
    ...
    <div class="login-box animated fadeInDownBig">
        ...
        <div class="alert alert-success alert-dismissible">
            ...
            <?php echo $this->lang->line('xin_reset_password_success_sent_email');?>
        </div>
        <?php endif;?>
        <div class="login-box-body">
            ...
            <p class="login-box-msg">
                <?php echo $this->lang->line('xin_admin_login');?><?php echo $company[0]->company_name;?></p>
	...
	if($system[0]->employee_login_id=='username'):
		...
		$ilogn_info2 = 'jsmt12@hrsale.com';
            ...
            <div class="form-group has-feedback">
                <input type="text" id="iusername" name="iusername" class="form-control"
                    placeholder="<?php echo $login_txt;?>" autocomplete="off">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="password" class="form-control" id="ipassword" name="ipassword" placeholder="Enter Password"
                    autocomplete="off">
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div class="row">
                <div class="col-xs-8"> <a href="<?php echo site_url('admin/auth/forgot_password');?>"
                        class="d-block small"><?php echo $this->lang->line('xin_forgot_password_link');?></a> </div>
                <!-- /.col -->
                <div class="col-xs-4">
                    <?php echo form_button(array('name' => 'hrsale_form', 'type' => 'submit', 'class' => 'btn btn-primary btn-block btn-flat save', 'content' => '<i class="fa fa-lock"></i> '.$this->lang->line('xin_login'))); ?>
                </div>
                <!-- /.col -->
            </div>
            <?php echo form_close(); ?>
            ...
            <!-- <div class="row">
                <div class="col-md-5">
                    <div class="btn-group">
                        <button type="button" class="btn bg-purple btn-flat btn-sm" data-toggle="dropdown"
                            aria-expanded="false">Login as</button>
                        <button type="button" class="btn bg-purple btn-flat btn-sm dropdown-toggle"
                            data-toggle="dropdown" aria-expanded="false"> <span class="caret"></span> <span
                                class="sr-only">Login as</span> </button>
                        <ul class="dropdown-menu" role="menu">
                            <li><a class="dropdown-item login-as" href="javascript:void(0);"
                                    data-username="<?php echo $ilogn_info;?>" data-password="fgrace$$##">Super Admin</a>
                            </li>
                            <li><a class="dropdown-item login-as" href="javascript:void(0);"
                                    data-username="<?php echo $ilogn_info2;?>"
                                    data-password="jhonsmith$$##">Employee</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <a target="_blank" href="<?php echo site_url('/');?>"
                        class="btn btn-warning btn-block btn-flat btn-sm">Jobs</a>
                </div>
                <div class="col-md-4">
                    <a target="_blank" href="<?php echo site_url('client/');?>"
                        class="btn btn-danger btn-block btn-flat btn-sm">Client Panel </a>
                </div>
    ...
    <script type="text/javascript" src="<?php echo base_url();?>skin/hrsale_assets/vendor/toastr/toastr.min.js">
    </script>
    ...
    <script type="text/javascript" src="<?php echo base_url();?>skin/hrsale_assets/hrsale_scripts/xin_login.js">
    </script>
    <script type="text/javascript">
    $(document).ready(function() {
