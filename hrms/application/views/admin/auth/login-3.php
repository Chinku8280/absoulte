...
<head>
    ...
    <link media="all" type="text/css" rel="stylesheet"
        href="<?php echo base_url();?>skin/hrsale_assets/css/hrsale/xin_login_3.css">
        ...
        <div class="row">
                ...
                <div class="authfy-login">
                    ...
                    <div class="authfy-panel panel-login text-center active">
                        <div class="authfy-heading">
                            <h3 class="auth-title"><?php echo $this->lang->line('xin_hrsale_login_to_your_account');?>
                            </h3>
                        </div>
                        <div class="row">
						...
						if($system[0]->employee_login_id=='username'):
							...
							$ilogn_info2 = 'jsmt12@hrsale.com';
                                ...
                                <div class="row remember-row">
                                    ...
                                    <div class="col-xs-6 col-sm-6">
                                        <p class="forgotPwd">
                                            <a href="<?php echo site_url('admin/auth/forgot_password');?>"
                                                class="lnk-toggler"><?php echo $this->lang->line('xin_forgot_password_link');?></a>
                                        </p>
                                    </div>
                                </div> <!-- ./remember-row -->
                                <div class="form-group">
                        ...
                        <!-- <div class="row">
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a class="dropdown-item login-as" href="javascript:void(0);"
                                                data-username="<?php echo $ilogn_info;?>"
                                                data-password="fgrace$$##">Super Admin</a></li>
                                        <li><a class="dropdown-item login-as" href="javascript:void(0);"
                            ...
                            <div class="col-md-4">
                                <a target="_blank" href="<?php echo site_url('/');?>"
                                    class="btn btn-warning btn-block btn-flat btn-sm">Jobs Listing</a>
                            </div>
                            <div class="col-md-4">
            ...
            <div class="col-md-7 col-lg-8 authfy-panel-right hidden-xs hidden-sm">
                <div class="hero-heading">
                    <div class="headline">
                        <h3><?php echo $this->lang->line('xin_hrsale_welcome');?>
                            <?php echo $company[0]->company_name;?></h3>
