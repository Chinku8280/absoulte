    ...
    <div id="accordion">
        <div class="box-header  with-border">
            <h3 class="box-title"><?php echo $this->lang->line('xin_add_new');?>
                <?php echo $this->lang->line('xin_termination');?></h3>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group" id="employee_ajax">
                                    <label for="employee"><?php echo $this->lang->line('xin_employee_terminated');?><i
                                            class="hrsale-asterisk">*</i></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label
                                                for="termination_date"><?php echo $this->lang->line('xin_termination_date');?><i
                                                    class="hrsale-asterisk">*</i></label>
                                            <input class="form-control date"
                                                placeholder="<?php echo $this->lang->line('xin_termination_date');?>"
                                                readonly name="termination_date" type="text">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="type"><?php echo $this->lang->line('xin_termination_type');?><i
                                                    class="hrsale-asterisk">*</i></label>
                                            <select class="select2" data-plugin="select_hrm"
                                                ...
                                                <option value="<?php echo $termination_type->termination_type_id?>">
                                                    <?php echo $termination_type->type;?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
...
<div class="box <?php echo $get_animate;?>">
    <div class="box-header with-border">
        <h3 class="box-title"> <?php echo $this->lang->line('xin_list_all');?>
            <?php echo $this->lang->line('left_terminations');?> </h3>
    </div>
    <div class="box-body">
