			 ...
			 ?>
                <li class="dropdown messages-menu">
                        ...
                        <li>
                            <ul class="menu" style="max-height: 245px;">
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li class="header"><a
                                                href="javascript:void(0);"><?php echo $this->lang->line('xin_leave_notifications');?></a>
                                        </li>
                    ...
                    ?>
                                    ...
                                    <ul class="menu">
                                        <li class="header"><a
                                                href="javascript:void(0);"><?php echo $this->lang->line('xin_projects_notifications');?></a>
                                        </li>
                                    ...
                                    <ul class="menu">
                                        <li class="header"><a
                                                href="javascript:void(0);"><?php echo $this->lang->line('xin_tasks_notifications');?></a>
                                        </li>
                                    ...
                                    <ul class="menu">
                                        <li class="header"><a
                                                href="javascript:void(0);"><?php echo $this->lang->line('dashboard_announcements');?></a>
                                        </li>
                                    ...
                                    <ul class="menu">
                                        <li class="header"><a
                                                href="javascript:void(0);"><?php echo $this->lang->line('left_tickets');?></a>
                                        </li>
                    ...
                    <ul class="dropdown-menu <?php echo $animated;?>">
                        ...
                        <li role="presentation">
                            <a role="menuitem" tabindex="-1" target="_blank"
                                href="<?php echo site_url();?>frontend/jobs/"><i
                                    class="fa fa-newspaper-o"></i><?php echo $this->lang->line('header_apply_jobs_frontend');?>
                            </a>
                        </li>
                        <?php  } ?>
                        <?php  } ?>
