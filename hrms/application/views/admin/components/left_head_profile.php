...
<div class="user-panel">
    ...
    <div class="user-panel">
        <div class="pull-left image"> <img src="<?php echo $cpimg;?>" class="img-circle"
                alt="<?php echo $user_info[0]->first_name. ' '.$user_info[0]->last_name;?>"> </div>
    ...
    <div class="user-panel">
        ...
        <div class="image">
            <img src="<?php echo $cpimg;?>" class="rounded-circle"
        ...
        <div class="info">
            ...
            <a href="<?php echo site_url('admin/profile?change_password=true')?>" class="link" data-toggle="tooltip"
                title="" data-original-title="<?php echo $this->lang->line('xin_employee_password');?>"><i
                    class="fa fa-key"></i></a>
            <a href="<?php echo $base_url;?>Auth/logout" class="link" data-toggle="tooltip" title=""
