    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <strong class="modal-title"><?php echo $this->lang->line('xin_delete_confirm'); ?></strong>
            </div>
            ...
            <div class="modal-footer">
                ...
                <?php echo form_button(array('name' => 'hrsale_form', 'type' => 'submit', 'class' => $this->Xin_model->form_button_class(), 'content' => '<i class="fa fa fa-check-square-o"></i> ' . $this->lang->line('xin_confirm_del'))); ?>
                <?php echo form_close(); ?> </div>
        </div>
    </div>
</div>
<div class="modal fadeInRight edit-modal-data animated " id="edit-modal-data" role="dialog"
    aria-labelledby="edit-modal-data" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" id="ajax_modal"></div>
    </div>
</div>
<div class="modal fadeInRight edit-modal-variation-data animated " id="edit-modal-variation-data" role="dialog"
    aria-labelledby="edit-modal-variation-data" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" id="ajax_variation_modal"></div>
    </div>
</div>
<div class="modal fadeInRight edit-modal-timelog-data animated " id="edit-modal-timelog-data" role="dialog"
    aria-labelledby="edit-modal-timelog-data" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" id="ajax_timelog_modal"></div>
    </div>
</div>
<div class="modal fadeInUp view-modal-data-bg animated " id="edit-modal-data" role="dialog"
    aria-labelledby="edit-modal-data" aria-hidden="true">
    <div class="modal-dialog modal-lg">
...
<!-- thhh -->
<div class="modal fadeInRight emo_monthly_pay_again animated " id="emo_monthly_pay_again" role="dialog" aria-labelledby="emo_monthly_pay_again" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" id="emo_monthly_pay_aj_again"></div>
    </div>
</div>
<div class="modal fadeInRight emo_hourly_pay_again animated " id="emo_hourly_pay_again" role="dialog" aria-labelledby="emo_hourly_pay_again" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" id="emo_hourly_pay_aj_again"></div>
    </div>
</div>
<!-- thhh -->
<div class="modal fadeInUp view-modal-data animated " id="view-modal-data" role="dialog"
    aria-labelledby="view-modal-data" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" id="ajax_modal_view"></div>
    </div>
</div>
<div class="modal fadeInUp view-modal-annoucement animated " id="view-modal-data" role="dialog"
    aria-labelledby="view-modal-data" aria-hidden="true">
    <div class="modal-dialog">
...
<div class="modal fadeInUp payroll_template_modal default-modal animated " id="payroll_template_modal" role="dialog"
    aria-labelledby="detail-modal-data" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" id="ajax_modal_payroll"></div>
    </div>
</div>
<div class="modal fadeInRight hourlywages_template_modal default-modal animated " id="hourlywages_template_modal"
    role="dialog" aria-labelledby="detail-modal-data" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" id="ajax_modal_hourlywages"></div>
    </div>
</div>
<div class="modal fadeInUp detail_modal_data default-modal animated " id="detail_modal_data" role="dialog"
    aria-labelledby="detail-modal-data" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" id="ajax_modal_details"></div>
    </div>
</div>
<div class="modal fadeInRight emo_monthly_pay animated " id="emo_monthly_pay" role="dialog"
    aria-labelledby="emo_monthly_pay" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" id="emo_monthly_pay_aj"></div>
    </div>
</div>
<div class="modal fadeInRight emo_hourly_pay animated " id="emo_hourly_pay" role="dialog"
    aria-labelledby="emo_hourly_pay" aria-hidden="true">
    <div class="modal-dialog">
...
<div class="modal fadeInRight add-modal-data animated " id="add-modal-data" role="dialog"
    aria-labelledby="add-modal-data" aria-hidden="true">
    <div class="modal-dialog">
...
<?php if ($this->router->fetch_class() == 'performance_maingoals'): ?>
    <div class="modal fadeInLeft delete-modal-maingoals animated " role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="alert alert-danger alert-dismissible fade in m-b-0" role="alert">
                    <strong><?php echo $this->lang->line('xin_d_not_restored'); ?></strong>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fadeInUp approve-modal-maingoals-kpi animated " tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <?php echo form_button(array('aria-label' => 'Close', 'data-dismiss' => 'modal', 'type' => 'button', 'class' => 'close', 'content' => '<span aria-hidden="true">×</span>')); ?>
                    <strong class="modal-title"><?php echo $this->lang->line('kpi_confirm_approve_maingoals'); ?></strong>
                </div>
    ...
    <div class="modal fadeInUp approve-modal-variable-kpi animated " tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <?php echo form_button(array('aria-label' => 'Close', 'data-dismiss' => 'modal', 'type' => 'button', 'class' => 'close', 'content' => '<span aria-hidden="true">×</span>')); ?>
                    <strong class="modal-title"><?php echo $this->lang->line('kpi_confirm_approve_variable'); ?></strong>
                </div>
    ...
    <div class="modal fadeInRight edit-modal-maingoals-data animated " id="edit-modal-maingoals-data" tabindex="-1"
        role="dialog" aria-labelledby="edit-modal-maingoals-data" aria-hidden="true">
    ...
    <div class="modal fadeInRight edit-modal-variable-data animated " id="edit-modal-variable-data" tabindex="-1"
        role="dialog" aria-labelledby="edit-modal-variable-data" aria-hidden="true">
    ...
    <div class="modal fadeInRight edit-modal-incidental-data animated " id="edit-modal-incidental-data" tabindex="-1"
        role="dialog" aria-labelledby="edit-modal-incidental-data" aria-hidden="true">
