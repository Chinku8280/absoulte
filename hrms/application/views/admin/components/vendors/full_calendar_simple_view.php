...
$(document).ready(function() {
    ...
    $('#calendar_hr').fullCalendar({
        ...
        eventClick: function(event, jsEvent, view) {
            ...
            $.each(event.participant, function(index, value) {
                participant +=
                    '<a href="profile.html" class="avatar w-24 mr-1"><img src="<?php echo base_url();?>' +
                    value + '"></a>';
            });
            var title = 'New Project';
            var description =
                '<div class="popover-body"><div><i class="fa fa-fw fa-calendar-o text-muted"></i> Monday 2</div><div><i class="fa fa-fw fa-clock-o text-muted"></i> 5:12am</div><div class="d-flex my-2">' +
                participant +
                '</div><div class="text-muted mb-2">Tricies neque, quis malesuada augue. Donec eleifend  nisl eu consectetur. </div></div>';
            $this.popover({
                html: true,
                title: title,
                content: description,
		...
		*/
        ...
        events: [
            ...
            <?php foreach($all_goals->result() as $goals):?> {
                ...
                color: '#3EACAB',
                unq: '10',
                participant: ['uploads/profile/default_female.jpg',
                    'uploads/profile/default_male.jpg'
                ]
            },
            <?php endforeach;?>
        ]
    ...
    $('.view-modal-data').on('show.bs.modal', function(event) {
        ...
        $.ajax({
            ...
            type: "GET",
            data: 'jd=1&is_ajax=1&mode=modal&data=event&event_date=' + ex_date + "&record=" +
                recrd,
            success: function(response) {
                if (response) {
...
<div id="module-opt" class="fc-popover fc-more-popover" style="display:none; z-index: 100;">
    <div class="fc-header fc-widget-header"> <span class="fc-close fc-icon fc-icon-x"></span><span
            class="fc-title"><?php echo $this->lang->line('xin_hr_add_options');?></span>
        <div class="fc-clear"></div>
    </div>
    <div class="fc-body fc-widget-content" style=" overflow: auto; height: 250px;">
        <div class="fc-event-container"> <a data-toggle="modal" data-target=".view-modal-data" data-record="0"
                class="fc-day-grid-event fc-h-event fc-event fc-start fc-end  fc-draggable">
                <div class="fc-content"> <span class="fc-title"><?php echo $this->lang->line('left_holidays');?></span>
                </div>
            </a> <a data-toggle="modal" data-target=".view-modal-data" data-record="1"
                class="fc-day-grid-event fc-h-event fc-event fc-start fc-end  fc-draggable">
                <div class="fc-content"> <span class="fc-title"><?php echo $this->lang->line('left_leave');?></span>
                </div>
            </a>
            <?php if($system[0]->module_travel=='true'){?>
            <a data-toggle="modal" data-target=".view-modal-data" data-record="2"
                class="fc-day-grid-event fc-h-event fc-event fc-start fc-end  fc-draggable">
                <div class="fc-content"> <span class="fc-title"><?php echo $this->lang->line('xin_travel');?></span>
                </div>
            </a>
            <?php } ?>
            <?php if($system[0]->module_training=='true'){?>
            <a data-toggle="modal" data-target=".view-modal-data" data-record="3"
                class="fc-day-grid-event fc-h-event fc-event fc-start fc-end  fc-draggable">
                <div class="fc-content"> <span
                        class="fc-title"><?php echo $this->lang->line('xin_hr_calendar_tranings');?></span></div>
            </a>
            <?php } ?>
            <a data-toggle="modal" data-target=".view-modal-data" data-record="4"
                class="fc-day-grid-event fc-h-event fc-event fc-start fc-end  fc-draggable">
                <div class="fc-content"> <span class="fc-title"><?php echo $this->lang->line('left_projects');?></span>
                </div>
            </a> <a data-toggle="modal" data-target=".view-modal-data" data-record="5"
                class="fc-day-grid-event fc-h-event fc-event fc-start fc-end  fc-draggable">
                <div class="fc-content"> <span class="fc-title"><?php echo $this->lang->line('left_tasks');?></span>
                </div>
            </a> <a data-toggle="modal" data-target=".view-modal-data" data-record="6"
                class="fc-day-grid-event fc-h-event fc-event fc-start fc-end  fc-draggable">
                <div class="fc-content"> <span class="fc-title"><?php echo $this->lang->line('xin_hr_events');?></span>
                </div>
            </a> <a data-toggle="modal" data-target=".view-modal-data" data-record="7"
                class="fc-day-grid-event fc-h-event fc-event fc-start fc-end  fc-draggable">
                <div class="fc-content"> <span
                        class="fc-title"><?php echo $this->lang->line('xin_hr_meetings');?></span></div>
            </a> <a data-toggle="modal" data-target=".view-modal-data" data-record="8"
                class="fc-day-grid-event fc-h-event fc-event fc-start fc-end  fc-draggable">
                <div class="fc-content"> <span
                        class="fc-title"><?php echo $this->lang->line('xin_hr_set_goal');?></span></div>
            </a>
        </div>
    </div>
</div>
