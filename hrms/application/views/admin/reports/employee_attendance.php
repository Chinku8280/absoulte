            ...
            <div class="row">
              <div class="col-md-3">
                <div class="form-group">
                  <input class="form-control attendance_date" placeholder="<?php echo $this->lang->line('xin_select_date');?>" readonly id="start_date" name="start_date" type="text" value="<?php echo date('d-m-Y');?>">
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-group">
                  <input class="form-control attendance_date" placeholder="<?php echo $this->lang->line('xin_select_date');?>" readonly id="end_date" name="end_date" type="text" value="<?php echo date('d-m-Y');?>">
                </div>
              </div>
          ...
          <table class="datatables-demo table table-striped table-bordered" id="xin_table">
            <thead>
              ...
              <tr>
                ...
                <th style="width:120px;"><?php echo $this->lang->line('clockin_latitude');?></th>
                <th style="width:120px;"><?php echo $this->lang->line('clockin_longitude');?></th>        
                <th style="width:120px;"><?php echo $this->lang->line('dashboard_clock_out');?></th>
                <th style="width:120px;"><?php echo $this->lang->line('clockout_latitude');?></th>
                <th style="width:120px;"><?php echo $this->lang->line('clockout_longitude');?></th> 
