  ...
  <div class="col-md-12">
    <div class="box">
      ...
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
            <?php $attributes = array('name' => 'employee_leave_reports', 'id' => 'employee_leave_reports', 'autocomplete' => 'off', 'class' => 'add form-hrm'); ?>
            <?php $hidden = array('euser_id' => $session['user_id']); ?>
            <?php echo form_open('admin/reports/employee_leave_reports', $attributes, $hidden); ?>
            <?php
            $data = array(
              'name'        => 'user_id',
              'id'          => 'user_id',
            ...
            <?php if ($user_info[0]->user_role_id == 1) { ?>
              ...
              <?php } ?>
              <div class="col-md-3">
                <label for="first_name">Employees</label>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="text" name="year" class="year form-control" placeholder="Year" id="year">
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-group">
  ...
  <div class="col-md-12 <?php echo $get_animate; ?>">
    <div class="box">
      <div class="box-header with-border">
        ...
        <button class="btn-primary" style="float: right;margin: 4px;" id="generate_employee_leave_report">Generate</button>
      </div>
      <div class="box-body">
