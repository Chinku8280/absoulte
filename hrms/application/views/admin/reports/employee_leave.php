                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input class="form-control training_date"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input class="form-control training_date"
                                        placeholder="<?php echo $this->lang->line('xin_select_date');?>" readonly
                                        id="end_date" name="end_date" type="text" value="<?php echo date('d-m-Y');?>">
                                </div>
                            </div>
                        </div>
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title"> <?php echo $this->lang->line('xin_view');?>
                    <?php echo $this->lang->line('xin_hr_report_leave_report');?> </h3>
