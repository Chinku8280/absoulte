            ...
            <div class="row">
              <div class="col-md-3">
                <div class="form-group">
                  <input class="form-control training_date" placeholder="<?php echo $this->lang->line('xin_select_date');?>" readonly id="start_date" name="start_date" type="text" value="<?php echo date('d-m-Y');?>">
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-group">
                  <input class="form-control training_date" placeholder="<?php echo $this->lang->line('xin_select_date');?>" readonly id="end_date" name="end_date" type="text" value="<?php echo date('d-m-Y');?>">
                </div>
              </div>
