            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="<?php echo $this->lang->line('xin_promotion_title');?>"
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input class="form-control d_date"
                            placeholder="<?php echo $this->lang->line('xin_promotion_date');?>" readonly
                            name="promotion_date" type="text" value="<?php echo $promotion_date;?>" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <table class="footable-details table table-striped table-hover toggle-circle">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="display: table-cell;"><?php echo $this->Xin_model->set_date_format($promotion_date);?>
                    </td>
                </tr>
                <tr>
