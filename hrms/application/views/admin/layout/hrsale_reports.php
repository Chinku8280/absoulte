            ...
            <table class="table table-bordered">
                <tbody>
                    ...
                    <?php if(in_array('117',$role_resources_ids)) { ?>
                        ...
                        <tr>
                        <td>5.</td>
                        <td><a href="<?php echo site_url('admin/reports/employee_leave_report');?>"> <i class="fa <?php echo $submenuicon;?>"></i> Employee Leave Report </a></td>
                        <td><span data-toggle="tooltip" data-placement="top" title="Active"><button type="button" class="btn icon-btn btn-xs btn-success active-lang mr-1"><span class="fa fa-check-circle"></span></button></span></td>
                        </tr>
                        <td>6.</td>
                        <td><a href="<?php echo site_url('admin/reports/employee_leave_balance_report');?>"> <i class="fa <?php echo $submenuicon;?>"></i>  Leave Balance Report </a></td>
                        <td><span data-toggle="tooltip" data-placement="top" title="Active"><button type="button" class="btn icon-btn btn-xs btn-success active-lang mr-1"><span class="fa fa-check-circle"></span></button></span></td>
                        </tr>

                        <td>7.</td>
                        <td><a href="<?php echo site_url('admin/reports/employee_leave_application_report');?>"> <i class="fa <?php echo $submenuicon;?>"></i> Leave Application Report </a></td>
                        <td><span data-toggle="tooltip" data-placement="top" title="Active"><button type="button" class="btn icon-btn btn-xs btn-success active-lang mr-1"><span class="fa fa-check-circle"></span></button></span></td>
                        </tr>
                    ...
                    <?php if(in_array('111',$role_resources_ids)) { ?>
                        ...
                        <td>8.</td>
                        <!-- <td><a href="<?php echo site_url('admin/reports/payslip');?>"> <i class="fa <?php echo $submenuicon;?>"></i> <?php echo $this->lang->line('xin_hr_reports_payslip');?> </a></td> -->
                        <td><a href="<?php echo site_url('admin/reports/salary_report');?>"> <i class="fa <?php echo $submenuicon;?>"></i> Salary Report </a></td>
                        <td><span data-toggle="tooltip" data-placement="top" title="Active"><button type="button" class="btn icon-btn btn-xs btn-success active-lang mr-1"><span class="fa fa-check-circle"></span></button></span></td>
                        </tr>
                    <?php } ?>
                </tbody>
