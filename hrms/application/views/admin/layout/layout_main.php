...
<body
    class="hrsale-layout hold-transition sidebar-mini skin-blue <?php echo $fixed_header; ?> <?php echo $boxed_wrapper; ?> <?php echo $compact_sidebar; ?>">
    <div class="wrapper">
        ...
        <aside class="main-sidebar">
            ...
            <div class="sidebar-footer">
                <?php if (in_array('60', $role_resources_ids)) { ?>
                    <!-- item-->
                    <a href="<?php echo site_url('admin/settings'); ?>" class="link" data-toggle="tooltip" title=""
                        data-original-title="<?php echo $this->lang->line('header_configuration'); ?>"><i
                            class="fa fa-cog fa-spin"></i></a>
                <?php } else { ?>
                    <a href="<?php echo site_url('admin/dashboard'); ?>" class="link" data-toggle="tooltip" title=""
                        data-original-title="<?php echo $this->lang->line('dashboard_title'); ?>"><i
                            class="fa fa-dashboard"></i></a>
                <?php } ?>
                <!-- item-->
                <a href="<?php echo site_url('admin/profile'); ?>" class="link" data-toggle="tooltip" title=""
                    data-original-title="<?php echo $this->lang->line('header_my_profile'); ?>"><i
                        class="fa fa-user"></i></a>
                <!-- item-->
                <!-- <?php $base_url = str_replace('/hrms', '', base_url()); ?>
                <a href="<?php echo $base_url; ?>logout" class="link" data-toggle="tooltip" title=""
                    data-original-title="<?php echo $this->lang->line('header_sign_out'); ?>"><i
                        class="fa fa-power-off"></i></a> -->
                <a href="<?php echo site_url('admin/logout'); ?>" class="link" data-toggle="tooltip" title=""
                    data-original-title="<?php echo $this->lang->line('header_sign_out'); ?>"><i
                        class="fa fa-power-off"></i></a>
        ...
        <div class="content-wrapper">
            <?php if ($this->router->fetch_class() == 'dashboard' || $this->router->fetch_class() == 'chat' || $this->router->fetch_class() == '1calendar' || $this->router->fetch_class() == 'profile' || $this->router->fetch_method() == 'attendance_dashboard') { ?>
                <!-- <div id="header_wrapper" class="header-lg overlay <?php echo $user_info[0]->user_role_id == 1 ? 'ecom-header' : '' ?> "> -->
