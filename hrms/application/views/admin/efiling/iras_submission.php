...
<div class="row">
    <div class="col-md-12" id="validation_result">
    </div>
    ...
    <div class="col-md-4">
        <div class="box mb-4 <?php echo $get_animate; ?>">
            <div class="box-header  with-border">
                <h3 class="box-title">IRAS Submission YA (Year of Assessment)</h3>
            </div>

            <div class="box-body">
                <?php $attributes = array('name' => 'ir8a_year_view', 'id' => 'ir8a_year_view', 'class' => 'm-b-1 add form-hrm');?>
                ...
                <div class="form-actions box-footer">
                    ...
                    <div id="reset_cont">
                        <div class="row">
                            <div class="col-md-6">
                                <?php $attributes = array('name' => 'iras_validation_form', 'id' => 'iras_validation_form', 'class' => 'm-b-1 add form-hrm');?>
                                <?php $hidden = array('user_id' => $session['user_id']);?>
                                <?php echo form_open('admin/efiling/validateIrasYear', $attributes, $hidden); ?>
                                <input type="hidden" name="year" value="<?php echo $year_a ?>">

                                <?php echo form_button(array('name' => 'hrsale_form', 'type' => 'submit', 'class' => 'btn-link', 'content' => 'Validate with IRAS')); ?>
                                <?php echo form_close(); ?>
                            </div>
                            <div class="col-md-6">
                                <?php $attributes = array('name' => 'iras_submission_form', 'id' => 'iras_submission_form', 'class' => 'm-b-1 add form-hrm');?>
                                <?php $hidden = array('user_id' => $session['user_id']);?>
                                <?php echo form_open('admin/efiling/submissionIrasYear', $attributes, $hidden); ?>
                                <input type="hidden" name="year" id="gen_fy" value="<?php echo $year_a ?>">

                                <?php echo form_button(array('name' => 'hrsale_form', 'type' => 'submit', 'class' => $this->Xin_model->form_button_class(), 'content' => 'Submit to IRAS')); ?>
                                <?php echo form_close(); ?>
                            </div>
                        </div>
                    </div>
