...
<div class="row match-heights">
        ...
        <div class="box">
            <div class="box-blocks">
                <div class="list-group">
                    <a class="list-group-item list-group-item-action nav-tabs-link active" href="#contract"
                        data-constant="1" data-constant-block="contract" data-toggle="tab" aria-expanded="true"
                        id="constant_1"> <i class="fa fa-pencil-square-o"></i>
                        <?php echo $this->lang->line('xin_e_details_contract_type');?> </a> <a
                        class="list-group-item list-group-item-action nav-tabs-link" href="#qualification"
                        data-constant="2" data-constant-block="qualification" data-toggle="tab" aria-expanded="true"
                        id="constant_2"> <i class="fa fa-square-o"></i>
                        <?php echo $this->lang->line('xin_e_details_qualification');?> </a> <a
                        class="list-group-item list-group-item-action nav-tabs-link" href="#document_type"
                        data-constant="3" data-constant-block="document_type" data-toggle="tab" aria-expanded="true"
                        id="constant_3"> <i class="fa fa-file-zip-o"></i>
                        <?php echo $this->lang->line('xin_e_details_dtype');?> </a>
                    <?php if($moduleInfo[0]->module_awards=='true'){?>
                    <a class="list-group-item list-group-item-action nav-tabs-link" href="#award_type" data-constant="4"
                        data-constant-block="award_type" data-toggle="tab" aria-expanded="true" id="constant_4"> <i
                            class="fa fa-trophy"></i> <?php echo $this->lang->line('xin_award_type');?> </a>
                    <?php } ?>
                    <a class="list-group-item list-group-item-action nav-tabs-link" href="#ethnicity_type"
                        data-constant="16" data-constant-block="ethnicity_type" data-toggle="tab" aria-expanded="true"
                        id="constant_16"> <i class="fa fa-road"></i>
                        <?php echo $this->lang->line('xin_ethnicity_type_title');?> </a>
                    <a class="list-group-item list-group-item-action nav-tabs-link" href="#leave_type" data-constant="5"
                        data-constant-block="leave_type" data-toggle="tab" aria-expanded="true" id="constant_5"> <i
                            class="fa fa-plane"></i> <?php echo $this->lang->line('xin_leave_type');?> </a> <a
                        class="list-group-item list-group-item-action nav-tabs-link" href="#warning_type"
                        data-constant="6" data-constant-block="warning_type" data-toggle="tab" aria-expanded="true"
                        id="constant_6"> <i class="fa fa-exclamation-triangle"></i>
                        <?php echo $this->lang->line('xin_warning_type');?> </a> <a
                        class="list-group-item list-group-item-action nav-tabs-link" href="#termination_type"
                        data-constant="7" data-constant-block="termination_type" data-toggle="tab" aria-expanded="true"
                        id="constant_7"> <i class="fa fa-user-times"></i>
                        <?php echo $this->lang->line('xin_termination_type');?> </a> <a
                        class="list-group-item list-group-item-action nav-tabs-link" href="#expense_type"
                        data-constant="8" data-constant-block="expense_type" data-toggle="tab" aria-expanded="true"
                        id="constant_8"> <i class="fa fa-money"></i> <?php echo $this->lang->line('xin_expense_type');?>
                    </a>
                    <a class="list-group-item list-group-item-action nav-tabs-link" href="#income_type"
                        data-constant="17" data-constant-block="income_type" data-toggle="tab" aria-expanded="true"
                        id="constant_17"> <i class="fa fa-gg"></i> <?php echo $this->lang->line('xin_income_type');?>
                    </a>
                    <?php if($moduleInfo[0]->module_recruitment=='true'){?>
                    <a class="list-group-item list-group-item-action nav-tabs-link" href="#job_type" data-constant="9"
                        data-constant-block="job_type" data-toggle="tab" aria-expanded="true" id="constant_9"> <i
                            class="fa fa-newspaper-o"></i> <?php echo $this->lang->line('xin_job_type');?> </a>
                    <a class="list-group-item list-group-item-action nav-tabs-link" href="#job_categories"
                        data-constant="15" data-constant-block="job_categories" data-toggle="tab" aria-expanded="true"
                        id="constant_15"> <i class="fa fa-newspaper-o"></i>
                        <?php echo $this->lang->line('xin_rec_job_categories');?> </a>
                    <?php } ?>
                    <a class="list-group-item list-group-item-action nav-tabs-link" href="#exit_type" data-constant="10"
                        data-constant-block="exit_type" data-toggle="tab" aria-expanded="true" id="constant_10"> <i
                            class="fa fa-sign-out"></i> <?php echo $this->lang->line('xin_employee_exit_type');?> </a>
                    <a class="list-group-item list-group-item-action nav-tabs-link" href="#travel_arr_type"
                        data-constant="11" data-constant-block="travel_arr_type" data-toggle="tab" aria-expanded="true"
                        id="constant_11"> <i class="fa fa-car"></i>
                        <?php echo $this->lang->line('xin_travel_arrangement_type');?> </a> <a
                        class="list-group-item list-group-item-action nav-tabs-link" href="#currency_type"
                        data-constant="13" data-constant-block="currency_type" data-toggle="tab" aria-expanded="true"
                        id="constant_13"> <i class="fa fa-dollar"></i>
                        <?php echo $this->lang->line('xin_currency_type');?> </a> <a
                        class="list-group-item list-group-item-action nav-tabs-link" href="#company_type"
                        data-constant="14" data-constant-block="company_type" data-toggle="tab" aria-expanded="true"
                        id="constant_14"> <i class="fa fa-building"></i>
                        <?php echo $this->lang->line('xin_company_type');?> </a>
                    <a class="list-group-item list-group-item-action nav-tabs-link" href="#security_level"
                        data-constant="15" data-constant-block="security_level" data-toggle="tab" aria-expanded="true"
                        id="constant_15">
                        <i class="fa fa-get-pocket"></i>
                        <?php echo $this->lang->line('xin_security_level');?>
                    </a>
                    <a class="list-group-item list-group-item-action nav-tabs-link" href="#claim_type"
                        data-constant="16" data-constant-block="claim_type" data-toggle="tab" aria-expanded="true"
                        id="constant_16">
                        <i class="fa fa-exchange" aria-hidden="true"></i>
                        <?php echo $this->lang->line('claim_type');?>
                    </a>
                    <a class="list-group-item list-group-item-action nav-tabs-link" href="#deduction_type"
                        data-constant="17" data-constant-block="deduction_type" data-toggle="tab" aria-expanded="true"
                        id="constant_16">
                        <i class="fa fa-exchange" aria-hidden="true"></i>
                        <?php echo $this->lang->line('xin_deduction_type');?>
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_e_details_contract_type');?>
            ...
            <div class="col-md-5">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_e_details_dtype');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
            ...
            <div class="col-md-5">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_e_details_edu_level');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
            ...
            <div class="col-md-5">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_e_details_language');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
                            <input type="text" class="form-control" name="name"
            ...
            <div class="col-md-5">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_skill');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
                            <input type="text" class="form-control" name="name"
            ...
            <div class="col-md-5">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_award_type');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
            ...
            <div class="col-md-5">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_leave_type');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
            ...
            <div class="col-md-5">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_warning_type');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
            ...
            <div class="col-md-5">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_termination_type');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
            ...
            <div class="col-md-5">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="company_name"><?php echo $this->lang->line('module_company_title');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_expense_type');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
            ...
            <div class="col-md-5">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_job_type');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
            ...
            <div class="col-md-5">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="job_category"><?php echo $this->lang->line('xin_rec_job_category');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
            ...
            <div class="col-md-5">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_employee_exit_type');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
            ...
            <div class="col-md-5">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_travel_arrangement_type');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
            ...
            <div class="col-md-5">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_currency_name');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
                            <input type="text" class="form-control" name="name"
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_currency_code');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_currency_symbol');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
            ...
            <div class="col-md-5">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_company_type');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
            ...
            <div class="col-md-5">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="ethnicity_type"><?php echo $this->lang->line('xin_ethnicity_type_title');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
            ...
            <div class="col-md-5">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="income_type"><?php echo $this->lang->line('xin_income_type');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
            ...
            <div class="col-md-5">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_security_level');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
    ...
    <div class="col-md-9 current-tab <?php echo $get_animate;?>" id="claim_type" style="display:none;">
        <div class="row">
            <div class="col-md-5">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title"> <?php echo $this->lang->line('xin_add_new');?>
                            <?php echo $this->lang->line('claim_type');?> </h3>
                    </div>
                    <div class="box-body">
                        <?php $attributes = array('name' => 'claim_type_info', 'id' => 'claim_type_info', 'autocomplete' => 'off', 'class' => 'm-b-1 add');?>
                        <?php $hidden = array('set_security_level' => 'UPDATE');?>
                        <?php echo form_open('admin/settings/claim_type_info/', $attributes, $hidden);?>
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('claim_type');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
                            <input type="text" class="form-control" name="claim_type"
                                placeholder="<?php echo $this->lang->line('claim_type');?>">
                        </div>
                        <div class="form-actions box-footer">
                            <button type="submit" class="btn btn-primary"> <i class="fa fa-check-square-o"></i>
                                <?php echo $this->lang->line('xin_save');?> </button>
            ...
            <div class="col-md-7">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="box-datatable table-responsive">
                            <table class="datatables-demo table table-striped table-bordered" id="xin_table_claim_type">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('xin_action');?></th>
                                        <th><?php echo $this->lang->line('claim_type');?></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
    ...
    <div class="col-md-9 current-tab <?php echo $get_animate;?>" id="deduction_type" style="display:none;">
        <div class="row">
            <div class="col-md-5">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title"> <?php echo $this->lang->line('xin_add_new');?>
                            <?php echo $this->lang->line('xin_deduction_type');?> </h3>
                    </div>
                    <div class="box-body">
                        <?php $attributes = array('name' => 'deduction_type_info', 'id' => 'deduction_type_info', 'autocomplete' => 'off', 'class' => 'm-b-1 add');?>
                        <?php $hidden = array('set_security_level' => 'UPDATE');?>
                        <?php echo form_open('admin/settings/deduction_type_info/', $attributes, $hidden);?>
                        <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_deduction_type');?>
                                <i class="hrsale-asterisk">*</i>
                            </label>
                            <input type="text" class="form-control" name="deduction_type"
                                placeholder="<?php echo $this->lang->line('xin_deduction_type');?>">
                        </div>
                        <div class="form-actions box-footer">
                            <button type="submit" class="btn btn-primary"> <i class="fa fa-check-square-o"></i>
                                <?php echo $this->lang->line('xin_save');?> </button>
            ...
            <div class="col-md-7">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="box-datatable table-responsive">
                            <table class="datatables-demo table table-striped table-bordered" id="xin_table_deduction_type">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('xin_action');?></th>
                                        <th><?php echo $this->lang->line('xin_deduction_type');?></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
