                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control d_date"
                            placeholder="<?php echo $this->lang->line('xin_start_date');?>" readonly name="start_date"
                            type="text" value="<?php echo $start_date;?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="end_date"><?php echo $this->lang->line('xin_end_date');?></label>
                        <input class="form-control d_date" placeholder="<?php echo $this->lang->line('xin_end_date');?>"
                            readonly name="end_date" type="text" value="<?php echo $end_date;?>">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="<?php echo $this->lang->line('xin_visit_purpose');?>"
                            name="visit_purpose" type="text" value="<?php echo $visit_purpose;?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="visit_place"><?php echo $this->lang->line('xin_visit_place');?></label>
                        <input class="form-control" placeholder="<?php echo $this->lang->line('xin_visit_place');?>"
                            name="visit_place" type="text" value="<?php echo $visit_place;?>">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label
                            for="expected_budget"><?php echo $this->lang->line('xin_expected_travel_budget');?></label>
                        <input class="form-control"
                            placeholder="<?php echo $this->lang->line('xin_expected_travel_budget');?>"
                            name="expected_budget" type="text" value="<?php echo $expected_budget;?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control"
                            placeholder="<?php echo $this->lang->line('xin_actual_travel_budget');?>"
                            name="actual_budget" type="text" value="<?php echo $actual_budget;?>">
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="select2" data-plugin="select_hrm"
                            data-placeholder="<?php echo $this->lang->line('xin_travel_mode');?>" name="travel_mode">
                            <option value="1" <?php if(1==$travel_mode):?> selected="selected" <?php endif;?>>
                                <?php echo $this->lang->line('xin_by_bus');?></option>
                            <option value="2" <?php if(2==$travel_mode):?> selected="selected" <?php endif;?>>
                                <?php echo $this->lang->line('xin_by_train');?></option>
                            <option value="3" <?php if(3==$travel_mode):?> selected="selected" <?php endif;?>>
                                <?php echo $this->lang->line('xin_by_plane');?></option>
                            <option value="4" <?php if(4==$travel_mode):?> selected="selected" <?php endif;?>>
                                <?php echo $this->lang->line('xin_by_taxi');?></option>
                            <option value="5" <?php if(5==$travel_mode):?> selected="selected" <?php endif;?>>
                                <?php echo $this->lang->line('xin_by_rental_car');?></option>
                        </select>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="select2" data-plugin="select_hrm"
                            data-placeholder="<?php echo $this->lang->line('xin_arragement_type');?>"
                            name="arrangement_type">
                            <?php foreach($travel_arrangement_types as $travel_arr_type) {?>
                            <option value="<?php echo $travel_arr_type->arrangement_type_id;?>"
                                <?php if($travel_arr_type->arrangement_type_id==$arrangement_type):?>
                                selected="selected" <?php endif;?>> <?php echo $travel_arr_type->type;?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="status" id="select2-demo-6" class="form-control" data-plugin="select_hrm"
                            ...
                            <option value="1" <?php if($status=='1'):?> selected <?php endif; ?>>
                                <?php echo $this->lang->line('xin_accepted');?></option>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control textarea"
                            placeholder="<?php echo $this->lang->line('xin_description');?>" name="description"
                            cols="30" rows="5" id="description2"><?php echo $description;?></textarea>
                    </div>
                </div>
            </div>
            <?php if($user_info[0]->user_role_id==1){ ?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="display: table-cell;">
                        <?php if(1==$travel_mode): $tmode = $this->lang->line('xin_by_bus');?>
                        <?php endif;?>
                ...
                <tr>
                    ...
                    <td style="display: table-cell;"><?php echo $this->Xin_model->currency_sign($expected_budget);?>
                    </td>
                </tr>
                <tr>
                    <th><?php echo $this->lang->line('xin_actual_travel_budget');?></th>
                    <td style="display: table-cell;"><?php echo $this->Xin_model->currency_sign($actual_budget);?>
                    </td>
                </tr>
                <tr>
                    <th><?php echo $this->lang->line('dashboard_xin_status');?></th>
                    <td style="display: table-cell;">
                        <?php if(0==$status): $tstatus = $this->lang->line('xin_pending');?>
                        <?php endif;?>
