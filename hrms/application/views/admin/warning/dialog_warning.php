                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="select2" data-plugin="select_hrm"
                            data-placeholder="<?php echo $this->lang->line('xin_warning_type');?>" name="type">
                            <option value=""></option>
                            <?php foreach($all_warning_types as $warning_type) {?>
                            <option value="<?php echo $warning_type->warning_type_id?>"
                                <?php if($warning_type->warning_type_id==$warning_type_id):?> selected="selected"
                                <?php endif;?>><?php echo $warning_type->type;?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control d_date"
                            placeholder="<?php echo $this->lang->line('xin_warning_date');?>" readonly
                            name="warning_date" type="text" value="<?php echo $warning_date;?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="display: table-cell;">
                        <?php if($status=='0'): $w_status = $this->lang->line('xin_pending');?>
                        <?php endif; ?>
                ...
                <tr>
                    ...
                    <td style="display: table-cell;"><?php if($attachment!='' && $attachment!='no file') {?>
                        <img src="<?php echo base_url().'uploads/warning/'.$attachment;?>" width="70px"
                            id="u_file">&nbsp; <a
                            href="<?php echo site_url()?>admin/download?type=warning&filename=<?php echo $attachment;?>"><?php echo $this->lang->line('xin_download');?></a>
                        <?php } ?>
                    </td>
                </tr>
                <tr>
