...
<div class="form-group">
    <label for="employee"><?php echo $this->lang->line('xin_employee');?><i class="hrsale-asterisk">*</i></label>
    <select name="employee_id" id="employee_idx" class="form-control employee_idx" data-plugin="select_hrm"
...
jQuery(document).ready(function() {
    ...
    jQuery("#employee_idx,.employee_idx").change(function() {
        var employee_id = jQuery(this).val();
        jQuery.get(base_url + "/get_employee_assigned_leave_types/" + employee_id, function(data,
            status) {
            jQuery('#get_leave_types,.get_leave_types').html(data);
        });
    });
