    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-4">
            <input class="form-control timepicker clear-1" placeholder="<?php echo $this->lang->line('xin_in_time');?>"  name="monday_in_time" type="text" value="<?php echo $monday_in_time;?>">
          </div>
          <div class="col-md-4">
            <input class="form-control timepicker clear-1" placeholder="<?php echo $this->lang->line('xin_out_time');?>"  name="monday_out_time" type="text" value="<?php echo $monday_out_time;?>">
          </div>
          <div class="col-md-1">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-4">
            <input class="form-control timepicker clear-2" placeholder="<?php echo $this->lang->line('xin_in_time');?>"  name="tuesday_in_time" type="text" value="<?php echo $tuesday_in_time;?>">
          </div>
          <div class="col-md-4">
            <input class="form-control timepicker clear-2" placeholder="<?php echo $this->lang->line('xin_out_time');?>"  name="tuesday_out_time" type="text" value="<?php echo $tuesday_out_time;?>">
          </div>
          <div class="col-md-1">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-4">
            <input class="form-control timepicker clear-3" placeholder="<?php echo $this->lang->line('xin_in_time');?>"  name="wednesday_in_time" type="text" value="<?php echo $wednesday_in_time;?>">
          </div>
          <div class="col-md-4">
            <input class="form-control timepicker clear-3" placeholder="<?php echo $this->lang->line('xin_out_time');?>"  name="wednesday_out_time" type="text" value="<?php echo $wednesday_out_time;?>">
          </div>
          <div class="col-md-1">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-4">
            <input class="form-control timepicker clear-4" placeholder="<?php echo $this->lang->line('xin_in_time');?>"  name="thursday_in_time" type="text" value="<?php echo $thursday_in_time;?>">
          </div>
          <div class="col-md-4">
            <input class="form-control timepicker clear-4" placeholder="<?php echo $this->lang->line('xin_out_time');?>"  name="thursday_out_time" type="text" value="<?php echo $thursday_out_time;?>">
          </div>
          <div class="col-md-1">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-4">
            <input class="form-control timepicker clear-5" placeholder="<?php echo $this->lang->line('xin_in_time');?>"  name="friday_in_time" type="text" value="<?php echo $friday_in_time;?>">
          </div>
          <div class="col-md-4">
            <input class="form-control timepicker clear-5" placeholder="<?php echo $this->lang->line('xin_out_time');?>"  name="friday_out_time" type="text" value="<?php echo $friday_out_time;?>">
          </div>
          <div class="col-md-1">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-4">
            <input class="form-control timepicker clear-6" placeholder="<?php echo $this->lang->line('xin_in_time');?>"  name="saturday_in_time" type="text" value="<?php echo $saturday_in_time;?>">
          </div>
          <div class="col-md-4">
            <input class="form-control timepicker clear-6" placeholder="<?php echo $this->lang->line('xin_out_time');?>"  name="saturday_out_time" type="text" value="<?php echo $saturday_out_time;?>">
          </div>
          <div class="col-md-1">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-4">
            <input class="form-control timepicker clear-7" placeholder="<?php echo $this->lang->line('xin_in_time');?>"  name="sunday_in_time" type="text" value="<?php echo $sunday_in_time;?>">
          </div>
          <div class="col-md-4">
            <input class="form-control timepicker clear-7" placeholder="<?php echo $this->lang->line('xin_out_time');?>"  name="sunday_out_time" type="text" value="<?php echo $sunday_out_time;?>">
          </div>
          <div class="col-md-1">
