                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control attendance_date"
                                        placeholder="<?php echo $this->lang->line('xin_e_details_date');?>" readonly
                                        id="attendance_date" name="attendance_date" type="text"
        ...
        <div class="box mb-4">
            <div class="box-header">
                ...
                <div class="box-tools pull-right">
                    ...
                    <button type="button" class="btn btn-xs btn-outline-primary" id="add_attendance_btn"
                        data-toggle="modal" style="display:none;" data-target=".add-modal-data"> <span
                            class="ion ion-md-add"></span> <?php echo $this->lang->line('xin_add_new');?></button>
                    <?php } else {?>
