                ...
                <div class="row">
                            ...
                            <div class="form-group" id="location_ajax">
                                ...
                                <select name="location_id" id="location_id" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('left_location'); ?>">
                                    ...
                                    <?php foreach ($all_office_shifts as $elocation) { ?>
                                        <option value="<?php echo $elocation->location_id ?>">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input class="form-control attendance_date" placeholder="<?php echo $this->lang->line('xin_select_date'); ?>" readonly id="attendance_date" name="attendance_date" type="text" value="<?php echo date('d-m-Y'); ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group"> &nbsp;
            ...
            <table class="datatables-demo table table-striped table-bordered" id="xin_table">
                <thead>
                    ...
                    <tr>
                        ...
                        <th style="width:100px;"><?php echo "Clock In Location"; ?></th>
                        <!-- <th style="width:100px;"><?php echo $this->lang->line('clockin_latitude'); ?></th>
                        <th style="width:100px;"><?php echo $this->lang->line('clockin_longitude'); ?></th> -->

                        <th style="width:100px;"><?php echo $this->lang->line('dashboard_clock_out'); ?></th>
                        <th style="width:100px;"><?php echo "Clock Out Location"; ?></th>
                        <!-- <th style="width:100px;"><?php echo $this->lang->line('clockout_latitude'); ?></th>
                        <th style="width:100px;"><?php echo $this->lang->line('clockout_longitude'); ?></th> -->
