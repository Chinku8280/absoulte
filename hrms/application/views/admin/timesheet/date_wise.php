                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <input class="form-control attendance_date"
                                ...
                                id="start_date" name="start_date" type="text" value="<?php echo date('d-m-Y');?>">
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <input class="form-control attendance_date"
                                placeholder="<?php echo $this->lang->line('xin_select_date');?>" readonly id="end_date"
                                name="end_date" type="text" value="<?php echo date('d-m-Y');?>">
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group"><label for="xin_start_date">&nbsp;</label><br />
                            <button type="submit"
                                class="btn btn-primary save"><?php echo $this->lang->line('xin_get');?></button>
                        </div>
                    </div>
                    <?php } ?>
                </div>
