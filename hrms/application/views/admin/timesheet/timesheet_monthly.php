                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input class="form-control d_month_year"
                                value="<?php if(!isset($month_year)): echo date('Y-m'); else: echo $month_year; endif;?>"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="company_id" id="aj_company" data-plugin="select_hrm"
                                ...
                                <option value="<?php echo $company->company_id?>"
                                    <?php if(isset($employee_id)): if($company->company_id==$company_id): ?>
                                    selected="selected" <?php endif; endif;?>><?php echo $company->name?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
...
<div class="box <?php echo $get_animate;?>">
    ...
    <div class="box-body">
        <div class="box-datatable table-responsive">
			...
			?>
                        <th><strong><?php echo '<div>'.$i.' </div><span style="text-decoration:underline;">'.$dayOfWeek.'</span>';?></strong>
                        </th>
                        <?php endfor; ?>
			...
			// print_r(in_array($attendance_date,$holiday_arr));
			// get leave/employee
			...
			$icurrent_date = strtotime(date('d-m-Y'));
