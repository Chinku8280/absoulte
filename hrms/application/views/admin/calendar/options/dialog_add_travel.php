...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('xin_add_new');?>
        <?php echo $this->lang->line('xin_travel');?></h4>
</div>
            ...
            <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control edate"
                                    ...
                                    name="end_date" type="text" id="end_date"
                                    value="<?php echo $this->Xin_model->set_date_format($_GET['event_date']);?>">
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group" id="employee_ajax">
                                <label
                                    for="employee_id"><?php echo $this->lang->line('dashboard_single_employee');?></label>
                    ...
                    <input type="hidden" name="company_id" id="company_id"
                        value="<?php echo $user_info[0]->company_id;?>" />
                    <?php } ?>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control"
                                    ...
                                    name="visit_purpose" type="text" id="visit_purpose">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control"
                                    placeholder="<?php echo $this->lang->line('xin_visit_place');?>" name="visit_place"
                                    type="text">
                            </div>
                        </div>
                    </div>
