...
<div class="form-group" id="designation_ajxx">
    <label for="designation"><?php echo $this->lang->line('xin_top_designation_level');?><i
            class="hrsale-asterisk">*</i></label>
    <select class="form-control" name="top_designation_id" data-plugin="select_hrm"
        data-placeholder="<?php echo $this->lang->line('xin_top_designation_level');?>">
