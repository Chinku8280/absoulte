            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-1"><b><?php echo active_employees();?>
                            <small><?php echo $this->lang->line('xin_employees_active');?></small></b></h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-1"><b><?php echo inactive_employees();?>
                            <small><?php echo $this->lang->line('xin_employees_inactive');?></small></b></h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-1"><b><?php echo $this->Xin_model->male_employees();?>%
                            <small><?php echo $this->lang->line('xin_gender_male');?></small></b></h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-1"><b><?php echo $this->Xin_model->female_employees();?>%
                            <small><?php echo $this->lang->line('xin_gender_female');?></small></b></h5>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="add_form" class="collapse add-form <?php echo $get_animate;?>" data-parent="#accordion" style="">
            <div class="box-body">
                ...
                <div class="form-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="username"><?php echo $this->lang->line('dashboard_username');?><i
                                                class="hrsale-asterisk">*</i></label>
                                        <input class="form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="date_of_birth"><?php echo $this->lang->line('xin_employee_dob');?><i
                                                class="hrsale-asterisk">*</i></label>
                                        <input class="form-control date_of_birth" 
                                    ...
                                    <div class="form-group">
                                        <label for="date_of_joining"
                                            class="control-label"><?php echo $this->lang->line('xin_employee_doj');?><i
                                                class="hrsale-asterisk">*</i></label>
                                        <input class="form-control date_of_joining" 
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control date_of_joining" 
                                            ...
                                            name="confirmation_date" type="text" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-<?php echo $ncolmd;?>">
                                    <div class="form-group" id="department_ajax">
                                        <label
                                            for="department"><?php echo $this->lang->line('xin_hr_main_department');?><i
                                                class="hrsale-asterisk">*</i></label>
                                ...
                                <div class="col-md-4" id="subdepartment_ajax">
                                    <div class="form-group">
                                        <label
                                            for="designation"><?php echo $this->lang->line('xin_hr_sub_department');?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="gender" data-plugin="select_hrm"
                                            ...
                                            <option value="Male"><?php echo $this->lang->line('xin_gender_male');?>
                                            </option>
                                            <option value="Female"><?php echo $this->lang->line('xin_gender_female');?>
                                            </option>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="reports_to" class="form-control" data-plugin="select_hrm"
                                    data-placeholder="<?php echo $this->lang->line('xin_reports_to');?>">
                                    <option value=""></option>
                                    <?php foreach(get_reports_to() as $reports_to) {?>
                                    <?php if($reports_to->user_id == $session['user_id']):?>
                                    <option value="<?php echo $reports_to->user_id?>"
                                        <?php if($reports_to->user_id == $session['user_id']):?> selected="selected"
                                        <?php endif;?>><?php echo $reports_to->first_name.' '.$reports_to->last_name;?>
                                    </option>
                                    <?php endif;?>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="reports_to" class="form-control" data-plugin="select_hrm"
                                    ...
                                    <?php foreach(get_reports_to() as $reports_to) {?>
                                    <option value="<?php echo $reports_to->user_id?>">
                                        <?php echo $reports_to->first_name.' '.$reports_to->last_name;?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="idtype">Identification Type
                                    <i class="hrsale-asterisk">*</i>
                                </label>
                                <select class="form-control" name="idtype" id="idtype" data-plugin="select_hrm"
                                    data-placeholder="Employee ID Type">
                                    <option value=""></option>
                                    <?php if($id_type) { foreach($id_type as $i) {?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="idno">NRIC/FIN No
                                    <i class="hrsale-asterisk">*</i>
                                </label>
                                <input type="text" class="form-control" placeholder="NRIC/FIN Number" name="idno">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Work Permit Number" name="work_permit_number">
                            </div>
                        </div>        
                    </div>
                    <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="immigrationstatus">Immigration Status
                                <i class="hrsale-asterisk">*</i>
                            </label>
                            <select class="form-control" name="immigrationstatus" id="immigrationstatus"
                                data-plugin="select_hrm" data-placeholder="Employee Immigration Status">
                                <option value=""></option>
                                <option value="1">Singapore Citizen</option>
                                <option value="2">Singapore PR</option>
                                <option value="3">Foreign Employee</option>
                            </select>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control date"
                                        placeholder="Singapore PR Effective date" name="prdate">
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php }?>
    <!-- <div class="row">
        <?php //$attendances = $this->Timesheet_model->attendance_all_time_checks(); $dat = $attendances->result();?>
                <div class="col-sm-12">
                  <div class="text-xs-center">
                    <div class="text-xs-center pb-0-5">
                      ...
                      <?php //echo form_open('admin/employees/set_clocking', $attributes, $hidden);?>
...
<div class="box <?php echo $get_animate;?>">
    <div class="box-header with-border">
        <h3 class="box-title"> <?php echo $this->lang->line('xin_list_all');?>
            <?php echo $this->lang->line('xin_employees');?> </h3>
        <?php if($user_info[0]->user_role_id==1){ ?>
        <div class="box-tools pull-right"> <a class="text-dark collapsed" data-toggle="collapse" href="#filter_hrsale"
                aria-expanded="false">
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="#tab_1-1" data-toggle="tab"><?php echo $this->lang->line('xin_list_all');?>
                        <?php echo $this->lang->line('xin_employees');?></a></li>
                <?php } ?>
                <?php
		...
		?>
                <li class="<?php echo $act_cls;?>"><a href="#tab_2-2"
                        data-toggle="tab"><?php echo $this->lang->line('xin_my_team');?></a></li>
            </ul>
            <div class="tab-content">
                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right"> <a class="text-dark collapsed" data-toggle="collapse"
                                    ...
                                    <button type="button" class="btn btn-xs btn-primary"> <span
                                        ...
                                        <?php echo $this->lang->line('xin_filter');?></button>
                                </a> <button type="button" class="btn btn-xs btn-primary dropdown-toggle"
                                    data-toggle="dropdown" aria-expanded="false"><span class="fa fa-bar-chart"></span>
                                    <?php echo $this->lang->line('xin_report');?> <span
                                        class="fa fa-caret-down"></span></button>
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo site_url('admin/reports/employees/');?>"
                                            target="_blank"><?php echo $this->lang->line('xin_filter_employement_report');?></a>
                                    </li>
                                </ul>
                            </div>
                            <?php } ?>
                ...
                <div class="tab-pane <?php echo $act_cls;?>" id="tab_2-2">
                    ...
                    <div class="box-body">
                        <div class="box-datatable table-responsive">
                            <table class="datatables-demo table table-striped table-bordered" id="xin_my_team_table"
                                style="width:100%;">
                                <thead>
                                    <tr>
                                        <th style="width:80px;"><?php echo $this->lang->line('xin_action');?></th>
