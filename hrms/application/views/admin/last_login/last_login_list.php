...
<div class="box <?php echo $get_animate;?>">
    <div class="box-header with-border">
        ...
        <?php if($user_info[0]->user_role_id==1){ ?><div class="box-tools pull-right"> <a class="text-dark collapsed"
                data-toggle="collapse" href="#filter_hrsale" aria-expanded="false">
