        ...
        <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input class="form-control edate"
                            placeholder="<?php echo $this->lang->line('xin_transfer_date');?>" readonly
                            name="transfer_date" type="text" value="<?php echo $transfer_date;?>">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group" id="department_ajx">
                        ...
                        <label
                            for="transfer_department"><?php echo $this->lang->line('xin_transfer_to_department');?></label>
                        <select class="select2" data-plugin="select_hrm"
                            data-placeholder="<?php echo $this->lang->line('xin_select_department');?>"
                            name="transfer_department" id="transfer_department">
                            <option value=""></option>
                            <?php foreach($cresult as $department) {?>
                            <option value="<?php echo $department->department_id?>"
                                <?php if($department->department_id==$transfer_department):?> selected="selected"
                ...
                <div class="col-md-6">
                    <div class="form-group" id="subdepartment_ajx">
                        <?php $sresult = get_sub_departments($transfer_department);?>
                        <label
                            for="transfer_subdepartment"><?php echo $this->lang->line('xin_transfer_to_subdepartment');?></label>
                        <select class="select2" data-plugin="select_hrm"
                            data-placeholder="<?php echo $this->lang->line('xin_select_sub_department');?>"
                            name="transfer_subdepartment" id="aj_subdepartment">
                            <option value=""></option>
                            <?php foreach($sresult as $sub_department) {?>
                            <option value="<?php echo $sub_department->sub_department_id; ?>"
                                <?php if($sub_department->sub_department_id ==$transfer_sub_department):?> selected="selected"
                                <?php endif;?>><?php echo $sub_department->department_name;?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                    <div class="form-group" id="designation_div">
                        <?php $dresult = $this->Designation_model->ajax_designation_information($transfer_sub_department);?>
                        <label
                            for="transfer_location"><?php echo $this->lang->line('xin_transfer_to_designation');?></label>
                        <select class="select2" data-plugin="select_hrm"
                            data-placeholder="<?php echo $this->lang->line('xin_transfer_select_designation');?>"
                            name="transfer_designation">
                            <option value=""></option>
                            <?php foreach($dresult as $designation) {?>
                            <option value="<?php echo $designation->designation_id ?>"
                                <?php if($designation->designation_id==$transfer_designation):?> selected="selected"
                                <?php endif;?>><?php echo $designation->designation_name;?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group" id="location_ajx">
                        ...
                        <label
                            for="transfer_location"><?php echo $this->lang->line('xin_transfer_to_location');?></label>
                        <select class="select2" data-plugin="select_hrm"
                            ...
                            <option value="<?php echo $location->location_id?>"
                                <?php if($location->location_id==$transfer_location):?> selected="selected"
                                <?php endif;?>><?php echo $location->location_name;?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select name="status" id="select2-demo-6" class="form-control" data-plugin="select_hrm"
                            data-placeholder="<?php echo $this->lang->line('xin_choose_status');?>">
...
$(document).ready(function() {
    ...
    jQuery("#transfer_department").change(function(){
        console.log(1);
		jQuery.get(base_url+"/get_edit_sub_departments/"+jQuery(this).val(), function(data, status){
        ...
        <table class="footable-details table table-striped table-hover toggle-circle">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="display: table-cell;"><?php echo $this->Xin_model->set_date_format($transfer_date);?>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th><?php echo $this->lang->line('xin_transfer_to_subdepartment');?></th>
                    <td style="display: table-cell;"><?php foreach($all_sub_department->result() as $sub_department) {?>
                        <?php if($transfer_sub_department==$sub_department->sub_department_id):?>
                        <?php echo $sub_department->department_name;?>
                        <?php endif;?>
                        <?php } ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="display: table-cell;">
                        <?php if($status=='0'): $t_status = $this->lang->line('xin_pending');?>
                        <?php endif; ?>
