    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input class="form-control" placeholder="<?php echo $this->lang->line('xin_title');?>" name="title"
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control d_date" name="start_date_modal" readonly="true" type="text"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control d_date" name="end_date_modal" readonly="true" type="text"
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <textarea class="form-control textarea" placeholder="<?php echo $this->lang->line('xin_description');?>"
                    name="description" cols="30" rows="6" id="description2"><?php echo $description;?></textarea>
            </div>
        </div>
    </div>
    <div class="form-group">
        <label for="summary"><?php echo $this->lang->line('xin_summary');?></label>
        <textarea class="form-control" placeholder="<?php echo $this->lang->line('xin_summary');?>" name="summary"
            cols="30" rows="3" id="summary"><?php echo $summary;?></textarea>
    </div>
...
$(document).ready(function() {
    ...
    jQuery("#ajx_company").change(function() {
        ...
        jQuery.get(escapeHtmlSecure(base_url + "/get_company_elocations_dialog/" + jQuery(this).val()),
            function(data, status) {
                jQuery('#location_ajx').html(data);
            });
    });
    jQuery("#aj_location_idx").change(function() {
        jQuery.get(base_url + "/get_location_departments_dialog/" + jQuery(this).val(), function(data,
            status) {
            jQuery('#department_ajx').html(data);
        });
    });
