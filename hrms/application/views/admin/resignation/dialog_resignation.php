            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control d_date"
                            placeholder="<?php echo $this->lang->line('xin_resignation_date');?>" readonly
                            name="resignation_date" type="text" value="<?php echo $resignation_date;?>">
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="status" data-plugin="select_hrm"
                            ...
                            <option value="1" <?php if($approval_status=='1'):?> selected <?php endif; ?>>
                                <?php echo $this->lang->line('xin_manager_level_title');?></option>
                            <?php } ?>
                            ...
                            <option value="2" <?php if($approval_status=='2'):?> selected <?php endif; ?>>
                                <?php echo $this->lang->line('xin_hrd_level_title');?></option>
                            <?php } ?>
                            <?php if($user_info[0]->user_role_id==1 || in_array('408',$role_resources_ids)){?>
                            <option value="3" <?php if($approval_status=='3'):?> selected <?php endif; ?>>
                                <?php echo $this->lang->line('xin_gm_om_level_title');?></option>
                            <?php } ?>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control textarea"
                            placeholder="<?php echo $this->lang->line('xin_resignation_reason');?>" name="reason"
                            cols="30" rows="5" id="reason2"><?php echo $reason;?></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <table class="footable-details table table-striped table-hover toggle-circle">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="display: table-cell;"><?php echo $this->Xin_model->set_date_format($resignation_date);?>
                    </td>
                </tr>
                <tr>
