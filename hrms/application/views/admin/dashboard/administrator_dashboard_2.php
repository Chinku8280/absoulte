      ...
      <div class="card mini-stat bg-primary">
        <div class="card-body mini-stat-img">
          ...
          <div class="text-white">
            ...
            <span class="badge badge-info"> <?php echo $this->lang->line('xin_employees_active'); ?> <?php echo active_employees(); ?> </span><span class="ml-2"> <span class="badge bg-red"> <?php echo $this->lang->line('xin_employees_inactive'); ?> <?php echo inactive_employees(); ?> </span></span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card mini-stat bg-green">
        <div class="card-body mini-stat-img">
          ...
          <div class="text-white">
            ...
            <a class="text-card-muted" href="<?php echo site_url('admin/roles'); ?>"><?php echo $this->lang->line('left_set_roles'); ?></a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card mini-stat bg-purple">
        <div class="card-body mini-stat-img">
          ...
          <div class="text-white">
            ...
            <a class="text-card-muted" href="<?php echo site_url('admin/timesheet/leave'); ?>"><?php echo $this->lang->line('xin_hr_view_applications'); ?></a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card mini-stat bg-red">
        <div class="card-body mini-stat-img">
          ...
          <div class="text-white">
            ...
            <a class="text-card-muted" href="<?php echo site_url('admin/settings'); ?>"><?php echo $this->lang->line('header_configuration'); ?></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="card mini-stat bg-yellow">
          <div class="card-body mini-stat-img">
            ...
            <div class="text-white">
              ...
              <h4 class="mb-4"><?php echo $this->lang->line('xin_performance_management'); ?></h4>
              <a class="text-card-muted" href="<?php echo site_url('admin/files'); ?>"><?php echo $this->lang->line('xin_hr_upload_documents'); ?></a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card mini-stat bg-yellow">
          <div class="card-body mini-stat-img">
            ...
            <div class="text-white">
              ...
              <a class="text-card-muted" href="<?php echo site_url('admin/timesheet/holidays'); ?>"><?php echo $this->lang->line('xin_view'); ?></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card mini-stat bg-red">
        <div class="card-body mini-stat-img">
          ...
          <div class="text-white">
            ...
            <h4 class="mb-4"><?php echo $this->lang->line('left_settings'); ?></h4>
            <a class="text-card-muted" href="<?php echo site_url('admin/theme'); ?>"><?php echo $this->lang->line('header_configuration'); ?></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="card mini-stat bg-aqua">
          <div class="card-body mini-stat-img">
            ...
            <div class="text-white">
              ...
              <span class="badge bg-red"> <?php echo $this->lang->line('xin_in_progress'); ?> <?php echo $this->Project_model->inprogress_projects(); ?> </span> <span class="ml-2"> <span class="badge badge-info"> <?php echo $this->lang->line('xin_completed'); ?> <?php echo $this->Project_model->complete_projects(); ?> </span></span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card mini-stat bg-green">
          <div class="card-body mini-stat-img">
            ...
            <div class="text-white">
              ...
              <span class="badge bg-red"> <?php echo $this->lang->line('xin_in_progress'); ?> <?php echo inprogress_tasks(); ?> </span> <span class="ml-2"> <span class="badge badge-info"> <?php echo $this->lang->line('xin_completed'); ?> <?php echo completed_tasks(); ?> </span></span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card mini-stat bg-aqua">
          <div class="card-body mini-stat-img">
            ...
            <div class="text-white">
              ...
              <a class="text-card-muted" href="<?php echo site_url('admin/settings/modules'); ?>"><?php echo $this->lang->line('xin_setup_modules'); ?></a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card mini-stat bg-green">
          <div class="card-body mini-stat-img">
            ...
            <div class="text-white">
              ...
              <a class="text-card-muted" href="<?php echo site_url('admin/timesheet/office_shift'); ?>"><?php echo $this->lang->line('xin_view'); ?></a>
            </div>
          </div>
        </div>
      </div>
...
$working = $this->Xin_model->get_attendance_using_status(1);
