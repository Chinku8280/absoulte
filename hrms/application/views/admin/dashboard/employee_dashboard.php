...
$emp_leaves = $this->Employees_model->getEmployeeLeavesForProrated($user_info[0]->user_id, date('Y'));
...
<div class="row <?php echo $get_animate; ?>">
  ...
  <?php if (in_array('46', $role_resources_ids)) { ?>
    ...
    $current_year = $this->Employees_model->getEmployeeLeaveCountForLeave(22, date('Y'), $session['user_id']);
    if ($current_year) {
      
        $applied_leaves = $this->Timesheet_model->getEmployeeAppliedLeaveCount(22, date('Y'), $session['user_id']);
      ...
      $type = $this->Timesheet_model->getEmployeeLeaveCount(22, $session['user_id']);
      $previous_year = $this->Employees_model->getEmployeeLeaveCountForLeave(22, date('Y') - 1, $session['user_id']);
      $current_year = $this->Employees_model->getEmployeeLeaveCountForLeave(22, date('Y'), $session['user_id']);
    ...
    ?>
      ...
      <div class="col-xl-6 col-md-3 col-12 hr-mini-state"> <a class="text-muted" href="<?php echo site_url('admin/timesheet/leave/'); ?>">
          <div class="info-box hrsalle-mini-stat"> <span class="info-box-icon bg-purple"><i class="fa fa-calendar"></i></span>
            <div class="info-box-content"> <span class="info-box-number">Available Leave</span>
              <span class="info-box-number"><?php echo $remaining_leave ?? 0 ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
        </a>
      ...
      <div class="col-xl-6 col-md-3 col-12 hr-mini-state"> <a class="text-muted" href="<?php echo site_url('admin/timesheet/leave/'); ?>">
          <div class="info-box hrsalle-mini-stat"> <span class="info-box-icon bg-purple"><i class="fa fa-calendar"></i></span>
            <div class="info-box-content"> <span class="info-box-number">Balance Leave</span>
              <span class="info-box-number"><?php echo $emp_leaves->balance_leave ?? 0 ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
        </a>
                ...
                ?>
                      <tr>
                        ...
                        <td class="text-truncate"><?php echo $task_catname; ?><br />
                          <a href="<?php echo site_url(); ?>admin/project/detail/<?php echo $et->project_id; ?>/"><?php echo $prj_name; ?></a>
                        </td>
                        ...
                        <td class="text-truncate">
                          <p class="m-b-0-5"><?php echo $this->lang->line('dashboard_completed'); ?> <span class="pull-xs-right"> <?php echo $et->task_progress; ?>%</span></p>
                          <progress class="progress <?php echo $progress_class; ?> progress-sm d-inline-block mb-0" value="<?php echo $et->task_progress; ?>" max="100"><?php echo $et->task_progress; ?>%</progress>
                        </td>
                      </tr>
                  <?php }
                  } ?>
              ...
              <table width="" class="table table-striped m-md-b-0">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <?php if ($user_info[0]->attendance_status == 0) { ?>
                        Absent
                      <?php } else { ?>
                        Present
                      <?php } ?>
