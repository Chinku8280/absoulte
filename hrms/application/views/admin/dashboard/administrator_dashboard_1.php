...
<div class="box-widget widget-user-2">
    ...
    <div class="widget-user-header">
        <h4 class="widget-user-username welcome-hrsale-user"><?php echo $this->lang->line('xin_title_wcb');?>,
            <?php echo $user[0]->first_name.' '.$user[0]->last_name;?>!</h4>
        <h5 class="widget-user-desc welcome-hrsale-user-text"><?php echo $this->lang->line('xin_title_today_is');?>
            <?php echo date('l, j F Y');?></h5>
    </div>
</div>
...
<div class="alert alert-warning alert-dismissible">
    ...
    <?php echo $this->lang->line('xin_title_license');?> <?php echo $clicense->license_name;?>
    <?php echo $this->lang->line('xin_title_is_going_to_expire_soon');?>
</div>
<?php endforeach;?>
...
<div class="alert alert-warning alert-dismissible">
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
    <h4><i class="icon fa fa-warning"></i> <?php echo $this->lang->line('xin_title_alert');?></h4>
    <?php echo $this->lang->line('xin_title_license');?> <?php echo $clicense_exp->license_name;?>
    <?php echo $this->lang->line('xin_title_is_expired');?>
</div>
<?php endforeach;?>
<?php endif;?><?php */?>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card p-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-1"><b><a
                                href="<?php echo site_url('admin/employees');?>"><?php echo $this->Employees_model->get_total_employees();?>
                                <small><?php echo $this->lang->line('xin_people');?></small></a></b></h5>
                    <small class="text-muted"><span class="badge badge-info">
                            <?php echo $this->lang->line('xin_employees_active');?> <?php echo active_employees();?>
                        </span><span class="ml-2"> <span class="badge bg-red">
                                <?php echo $this->lang->line('xin_employees_inactive');?>
                                <?php echo inactive_employees();?> </span></span></small>
                </div>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-lg-3">
        <div class="card p-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-1"><b><a href="<?php echo site_url('admin/roles');?>">
                                <?php echo $this->lang->line('xin_roles');?>
                                <small><?php echo $this->lang->line('xin_permission');?></small></a></b></h5>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card p-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-1"><b><a href="<?php echo site_url('admin/timesheet/leave');?>">
                                <?php echo $this->lang->line('left_leave');?>
                                <small><?php echo $this->lang->line('xin_performance_management');?></small></a></b>
                    </h5>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card p-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-1"><b><a href="<?php echo site_url('admin/settings');?>">
                                <?php echo $this->lang->line('xin_configure_hr');?>
                                <small><?php echo $this->lang->line('left_settings');?></small></a></b></h5>
            ...
            <div class="card-body">
                ...
                <div class="progress progress-sm">
                    <div class="progress-bar progress-bar-info w-75" role="progressbar"
                        ...
                        aria-valuemax="100" style="width: <?php echo $this->Xin_model->set_percentage($emp_abs);?>%">
                    </div>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="progress progress-sm">
                    <div class="progress-bar progress-bar-info w-75" role="progressbar"
                        ...
                        aria-valuemax="100" style="width: <?php echo $this->Xin_model->set_percentage($emp_work);?>%">
                    </div>
                </div>
                <div class="d-flex justify-content-between mt-2">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <h3 class="text-info fw-bold"><a class="text-card-mduted"
                            href="<?php echo site_url('admin/project');?>"><?php echo $this->Xin_model->get_all_projects();?></a>
                    </h3>
                </div>
                <div class="progress progress-sm">
                    <div class="progress-bar progress-bar-info w-75" role="progressbar"
                        ...
                        aria-valuemax="100"
                        style="width: <?php echo $this->Xin_model->set_percentage($proj_percnt);?>%"></div>
                </div>
                <div class="d-flex justify-content-between mt-2">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    ?>
                    <h3 class="text-info fw-bold"><a class="text-card-mduted"
                            href="<?php echo site_url('admin/timesheet/tasks');?>"><?php echo $this->Xin_model->get_all_tasks();?></a>
                    </h3>
                </div>
                <div class="progress progress-sm">
                    <div class="progress-bar progress-bar-info w-75" role="progressbar"
                        ...
                        aria-valuemax="100"
                        style="width: <?php echo $this->Xin_model->set_percentage($task_percnt);?>%"></div>
                </div>
                <div class="d-flex justify-content-between mt-2">
                    <p class="text-muted mb-0"><?php echo $this->lang->line('xin_completed');?></p>
            ...
            <div class="box-body">
                <div class="box-block">
					...
					?>
                                        <tr>
                                            <td>
                                                <div style="width:4px;border:5px solid <?php echo $c_color[$j];?>;">
                                                </div>
                                            </td>
                                            <td><?php echo htmlspecialchars_decode($department->department_name);?>
                                                (<?php echo $query->num_rows();?>)</td>
                                        </tr>
                                        <?php $j++; } ?>
                                        <?php  } ?>
                                    </tbody>
            ...
            <div class="box-body">
                <div class="box-block">
					...
					?>
                                        <tr>
                                            <td>
                                                <div style="width:4px;border:5px solid <?php echo $c_color2[$k];?>;">
                                                </div>
                                            </td>
                                            <td><?php echo htmlspecialchars_decode($designation->designation_name);?>
                                                (<?php echo $query1->num_rows();?>)</td>
                                        </tr>
                                        <?php $k++; } ?>
                                        <?php  } ?>
                                    </tbody>
...
<div class="row mt--2 <?php echo $get_animate;?>" style="display:none">
    <div class="col-md-12">
        <div class="card full-height">
            <div class="card-body">

                <div class="card-title"><?php echo $this->lang->line('xin_hrsale_paid_salaries_account_balances');?>
                </div>
                ...
                <div class="row py-3">
                    <div class="col-md-3 d-flex flex-column justify-content-around">
                        <h6 class="fw-bold text-uppercase text-success op-8">
                            <?php echo $this->lang->line('dashboard_total_expenses');?></h6>
                        <h3 class="fw-bold">
                    ...
                    <div class="col-md-3 d-flex flex-column justify-content-around">
                        <h6 class="fw-bold text-uppercase text-danger op-8">
                            <?php echo $this->lang->line('dashboard_total_salaries');?></h6>

                    </div>
                    <div class="col-md-3 d-flex flex-column justify-content-around">
                        <h6 class="fw-bold text-uppercase text-info op-8">
                            <?php echo $this->lang->line('xin_acc_account_balances');?></h6>

                    </div>
                    <div class="col-md-3 d-flex flex-column justify-content-around">
                        <h6 class="fw-bold text-uppercase text-warning op-8">
                            <?php echo $this->lang->line('xin_hrsale_travel_expenses');?></h6>
        ...
        <div class="box box-body hr-mini-state hrsalle-mini-stat">
            <a class="text-card-muted" href="<?php echo site_url('admin/tickets');?>">
                <div class="flexbox"> <span class="fa fa-ticket text-primary font-size-50"></span> <span
                        class="font-size-40 font-weight-400"><?php echo total_tickets();?></span> </div>
        ...
        <div class="box box-body hr-mini-state hrsalle-mini-stat">
            <a class="text-card-muted" href="<?php echo site_url('admin/tickets');?>">
                <div class="flexbox"> <span class="fa fa-server text-danger font-size-50"></span> <span
                        class="font-size-40 font-weight-400"><?php echo total_open_tickets();?></span> </div>
        ...
        <div class="box box-body hr-mini-state hrsalle-mini-stat">
            <a class="text-card-muted" href="<?php echo site_url('admin/tickets');?>">
                <div class="flexbox"> <span class="ion ion-thumbsup text-success font-size-50"></span> <span
                        class="font-size-40 font-weight-400"><?php echo total_closed_tickets();?></span> </div>
