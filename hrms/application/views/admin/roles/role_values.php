<script type="text/javascript">
	...
	jQuery("#treeview_r1").kendoTreeView({
		...
		dataSource: [
			...
			// 			id: "",
			// 			class: "role-checkbox",
			// 			text: "<?php echo $this->lang->line('left_job_interviews'); ?>",
			// 			add_info: "<?php echo $this->lang->line('xin_add_delete'); ?>",
			// 			value: "52",
			// 			items: [{
			// 					id: "",
			// 					class: "role-checkbox",
	...
	jQuery("#treeview_r2").kendoTreeView({
		...
		dataSource: [
			...
			},
			{
				id: "",
				class: "role-checkbox",
				text: "<?php echo $this->lang->line('xin_notify_top'); ?>",
				add_info: "<?php echo $this->lang->line('xin_view'); ?>",
				value: "90",
			},
			// {
			// 	id: "",
			// 	class: "role-checkbox",
			// 	text: "<?php echo $this->lang->line('header_apply_jobs'); ?>",
			// 	add_info: "<?php echo $this->lang->line('xin_view'); ?>",
			// 	value: "91",
			// },
			{
				id: "",
				class: "role-checkbox",
				text: "<?php echo $this->lang->line('xin_theme_settings'); ?>",
				add_info: "<?php echo $this->lang->line('xin_theme_settings'); ?>",
				value: "94",
			},
			{
				id: "",
			...
			},
			{
				id: "",
				class: "role-checkbox",
				text: "<?php echo $this->lang->line('xin_hr_imports'); ?>",
