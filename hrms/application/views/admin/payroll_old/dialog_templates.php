...
<div class="modal-header animated fadeInRight">
    ...
    <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('xin_payroll_employee_salary_details');?>
    </h4>
</div>
<div class="modal-body animated fadeInRight">
                                ...
                                <div class="box box-widget widget-user-2">
                                    ...
                                    <div class="widget-user-header bg-yellow1">
                                        <div class="widget-user-image"> <img class="img-circle"
                                                src="<?php echo base_url().$u_file;?>"
                                                alt="<?php echo $first_name.' '.$last_name;?>"> </div>
                                        <!-- /.widget-user-image -->
                                    ...
                                    <div class="no-padding">
                                        <ul class="nav nav-stacked">
                                            <li><a href="javascript:void(0);"><?php echo $this->lang->line('xin_emp_id');?>
                                                    asd<span class="pull-right"><?php echo $employee_id;?></span></a>
                                            </li>
                                            <li><a href="javascript:void(0);"><?php echo $this->lang->line('left_department');?>
                                                    <span class="pull-right"><?php echo $department_name;?></span></a>
                                            </li>
                                            <li><a href="javascript:void(0);"><?php echo $this->lang->line('xin_joining_date');?><span
                                                        class="pull-right badge"><?php echo $date_of_joining;?></span></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
    ...
    <div class="row mb-1">
        <div class="col-sm-12 col-xs-12 col-xl-12">
            <div class="card-header text-uppercase"><b><?php echo $this->lang->line('xin_payroll_salary_details');?></b>
            </div>
				...
				?>
                      ...
                      ?>
                                            <tr>
                                                <td><strong><?php echo $sl_allowances->allowance_title;?>:</strong>
                                                    <span
                                                        class="pull-right"><?php echo $this->Xin_model->currency_sign($eallowance_amount);?></span>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                            <tr>
                    ...
                    <div class="card hrsale-payslip mb-2">
                      ...
                      ?>
                                            ...
                                            <tr>
                                                <td><strong><?php echo $sl_commissions->payment_deduction_name;?>:</strong>
                                                    <span
                                                        class="pull-right"><?php echo $this->Xin_model->currency_sign($ecommissions_amount);?></span>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                            <tr>
                    ...
                    <div class="card hrsale-payslip mb-2">
                      ...
                      ?>
                                            ...
                                            <tr>
                                                <td><strong><?php echo $r_loan->loan_deduction_title;?>:</strong> <span
                                                        class="pull-right"><?php echo $this->Xin_model->currency_sign($er_loan);?></span>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                            <tr>
                    ...
                    <div class="card hrsale-payslip mb-2">
                        <div class="card-header"> <a class="text-dark collapsed" data-toggle="collapse"
                                href="#statutory_deductions" aria-expanded="false">
					  ...
					  //$other_payments_amount += $sl_other_payments->payments_amount;?>
                                            <tr>
                                                <td><strong><?php echo $sl_other_payments->payments_title;?>:</strong>
                                                    <span
                                                        class="pull-right"><?php echo $this->Xin_model->currency_sign($epayments_amount);?></span>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                            <tr>
                            ...
                            <div class="col-md-12 col-sm-7">
                                <div class="box box-widget widget-user-2">
                                    ...
                                    <div class="no-padding">
                                        <ul class="nav nav-stacked">
                                            <li><a href="javascript:void(0);"><?php echo $this->lang->line('xin_emp_id');?>
                                                    <span class="pull-right"><?php echo $employee_id;?></span></a></li>
                                            <li><a href="javascript:void(0);"><?php echo $this->lang->line('left_department');?>
                                                    <span class="pull-right"><?php echo $department_name;?></span></a>
                                            </li>
                                            <li><a href="javascript:void(0);"><?php echo $this->lang->line('xin_joining_date');?><span
                    ...
                    <div class="card hrsale-payslip mb-2">
						...
						?>
                                            ...
                                            <tr>
                                                <td><strong><?php echo $this->lang->line('xin_acc_total');?>:</strong>
                                                    <span
                                                        class="pull-right"><?php echo $this->Xin_model->currency_sign($total_count);?></span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="table-responsive" data-pattern="priority-columns">
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><strong>
                                                        <?php echo $sl_commissions->payment_deduction_name;?>
                                ...
                                <div class="table-responsive" data-pattern="priority-columns">
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><strong><?php echo $r_loan->loan_deduction_title;?>:</strong> <span
                                                        class="pull-right"><?php echo $this->Xin_model->currency_sign($r_loan->loan_deduction_amount);?></span>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                            <tr>
