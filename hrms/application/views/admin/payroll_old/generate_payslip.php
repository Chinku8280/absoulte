                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group" id="employee_ajax">
                                    <label
                                        for="department"><?php echo $this->lang->line('dashboard_single_employee');?></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control month_year"
                                        placeholder="<?php echo $this->lang->line('xin_select_month');?>" readonly
                                        id="month_year" name="month_year" type="text" value="<?php echo date('m-Y',strtotime('-1 month'));?>">
                                </div>
                            </div>
                        </div>
                        <?php
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="company_id" id="aj_companyx"
                                        data-plugin="select_hrm"
                            ...
                            <div class="col-md-3" id="location_ajax">
                                <div class="form-group">
                                    ...
                                    <select name="location_id" id="aj_location_id" class="form-control"
                                        data-plugin="select_hrm"
                            ...
                            <div class="col-md-3">
                                <div class="form-group" id="department_ajax">
                                    ...
                                    <select class="form-control" id="aj_subdepartments" name="department_id"
                                        data-plugin="select_hrm"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control month_year"
                                        placeholder="<?php echo $this->lang->line('xin_select_month');?>" readonly
                                        name="month_year" type="text" value="<?php echo date('m-Y',strtotime('-1 month'));?>"
                                        id="bmonth_year">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-primary"> <i
                                                class="fa fa-check-square-o"></i>
                                            <?php echo $this->lang->line('xin_payroll_bulk_payment');?> </button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="box <?php echo $get_animate;?>">
    <div class="box-header with-border">
        <h3 class="box-title"> <?php echo $this->lang->line('xin_payment_info_for');?> <span class="text-danger"
                id="p_month"><?php echo date('Y-m',strtotime('-1 month'));?></span> </h3>
