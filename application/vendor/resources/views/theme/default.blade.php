...
<link href="{!! asset('public/datatables/css/rowReorder.dataTables.min.css') !!}" rel="stylesheet">
  ...
  <body>
    ...
    <script src="{{asset('public/theme/dist/js/demo-theme.min.js?1674944402')}}"></script>
...
<script type="text/javascript" src="{!! asset('public/datatables/js/dataTables.buttons.min.js') !!}"></script>
  <script type="text/javascript" src="{!! asset('public/datatables/js/dataTables.responsive.min.js') !!}">
</script>
