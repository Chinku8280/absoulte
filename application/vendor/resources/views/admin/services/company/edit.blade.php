                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-1">
                          <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="person_incharge_name" value="{{$data->person_incharge_name}}"
                                  placeholder="Enter Name">
                          </div>
                      </div>
                        <div class="col-lg-6 col-md-6 col-sm-1">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-1">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="company_address"
                                placeholder="Enter Name" value="{{$data->company_address}}">
                        </div>
                      </div>
                        <div class="col-lg-6 col-md-6 col-sm-1">
                          <div class="mb-3">
                              <label class="form-label">Website<span class="text-danger">*</span></label>
                              <input type="text" class="form-control" name="company_website" placeholder="Enter Website url" value="{{$data->website}}">
                          </div>
                      </div>
                    </div>
                    <div class="mb-3">
                      <label class="form-label"> Company Logo</label>
                      <input type="file" name="company_logo" id="" class="form-control" value="{{$data->company_logo}}">
                    </div>
                     {{-- <div class="col-lg-12">
                      <div class="mb-3">
                            <label class="form-label">Terms & Condition <span class="text-danger"></span></label>
                           <textarea name="term_condition" cols="30" rows="4" class="form-control">{{$data->term_condition}}</textarea>
                        </div>
                   </div> --}}
                    </div>
                    <div class="row">
