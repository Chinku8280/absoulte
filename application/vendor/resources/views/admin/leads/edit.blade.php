<style>
  ...
  color: white;
        ...
        <div class="modal-header">
          <h5 class="modal-title">Update New Lead {{$lead->id}}</h5>
            ...
            <li class="nav-item">
              ...
              <div class="tab-content mt-3" style="border: none;">
                <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
                    ...
                    <div class="col-md-3">
                      <ul class="nav nav-pills nav-pills-primary" role="tablist">
                        <li class="nav-item me-2" role="presentation">
                          <a href="#residential-view" id="residential-view-table" class="nav-link {{ $customer->customer_type === 'residential_customer_type' ? ' active' : '' }}"
                            data-bs-toggle="tab" aria-selected="{{ $customer->customer_type === 'residential_customer_type' ? 'true' : 'false' }}" role="tab">Residential</a>
                        </li>
                        <li class="nav-item me-2" role="presentation">
                          <a href="#commercial-view" class="nav-link {{ $customer->customer_type === 'commercial_customer_type' ? ' active' : '' }}" id="commercial-view-table"
                            data-bs-toggle="tab" aria-selected="{{ $customer->customer_type === 'commercial_customer_type' ? 'true' : 'false' }}" role="tab" tabindex="-1">Commercial</a>
                        </li>
                      </ul>
                      ...
                      <div class="tab-content mt-3">
                        <div class="tab-pane fade show active" id="residential-view" role="tabpanel">
                          <div class="mb-3">
                            ...
                            <div class="input-icon mb-3">
                              <input type="text" value="" class="form-control" placeholder="Search…" onkeypress="Search('1')" id="residential">
                          ...
                          <div class="mb-3" id="residential_Search">
                            ...
                            <div class="card card-active">
                              ...
                              <div class="card-body d-flex justify-content-between">
                                <div class="my-auto">
                                  <label class="mb-0 text-black fw-bold " style="font-size: 14px">{{$customer->customer_name}}</label>
                        ...
                        <div class="tab-pane fade" id="commercial-view" role="tabpanel">
                          <div class="mb-3">
                            <label class="form-label">Search By</label>
                            <div class="input-icon mb-3">
                              <input type="text" value="" class="form-control" placeholder="Search…" onkeypress="Search('0')" id="commercial">
                              <span class="input-icon-addon">
                                <!-- Download SVG icon from http://tabler-icons.io/i/search -->
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                  viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                          ...
                          <div class="mb-3" id="commercialList" style="display: {{ $customer->customer_type === 'commercial_customer_type' ? 'block' : 'none' }};">
                 ...
                 <div class="card mt-3 customer-card commercial-card" id="commercial-card" style="display: {{ $customer->customer_type === 'commercial_customer_type' ? 'block' : 'none' }};">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-12">
                              <div class="">
                                ...
                                <div class="input-icon mb-3">
                                  <input type="text" value="" class="form-control" placeholder="Search…" oninput="searchService()" id="service-search">
                                  <span class="input-icon-addon">
                                    <!-- Download SVG icon from http://tabler-icons.io/i/search -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                      viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                  ...
                                  <div class="mt-3" >
                                    ...
                                    <div class="productsubshow mt-3" style="display: none;">
                                      ...
                                      <div class="table-responsive">
                                        <table
                                          class="table card-table table-vcenter text-center text-nowrap table-transparent" id="service-table">
                                          <thead>
                                            <tr>
                                              <th>Service Id</th>
                                              <th>Image</th>
                    ...
                    <div class="col-md-8 pe-0">
                      <div class="card">
                        <div class="card-body p-0">
                          <div class="table-responsive">
                            <!-- <table class="table card-table table-vcenter text-center text-nowrap" id="selected-services-table"
                                 style="width:100%"> -->
                              <table class="table card-table table-vcenter text-center text-nowrap" id="selected-services-table" style="width:100%">
  <thead>
    <tr>
      <th>SERVICE ID</th>
      <th>Service</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$service->unit_price }}</td>
       <td><input type="text" class="form-control quantity-input" value="{{ $service->quantity }}"></td>
      
       <td class="p-0"><input type="text" class="form-control discount-input" name="discount[{{ $service->service_id }}]" value="{{ $service->discount }}"></td>
       <td style="display: none;">
     123
       </td>
     <td><input type="text" class="form-control" placeholder="Gross Amount" value="{{ $service->gross_amount }}"></td>


      <td>
        <button class="btn btn-danger ripple" type="button">
          <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-playstation-x m-0" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
    ...
    @endforeach
            ...
            <thead>
            <!-- {{$lead->amount}} | {{ $lead->tax }} |{{ $lead->grand_total }} -->
            <tr>
              ...
              <tr>
                <th colspan="5" style="text-align: end;">Tax</th>
                <th><input type="number" value="{{$lead->tax_percent}}" class="form-control" /></th>
                <th colspan="1" style="text-align: end;">Tax Amount</th>
                <th class="" colspan="2">{{ $lead->tax }}</th>
              </tr>
              <tr>
                <th colspan="7" style="text-align: end;">Grand Total</th>
                <th class="" colspan="2">{{ $lead->grand_total }}</th>
              </tr>
            </thead>
  </table>
                        ...
                        <div class="customer-card-slide3">
                           <div class="card-body">
                              ...
                              <p class="card-p d-flex align-items-center mb-2 ">
                                 <i class="fa-solid fa-phone me-2" style="font-size: 14px;"></i>{{$customer->mobile_number}}
                              </p>
                              <p class="card-p  d-flex align-items-center mb-2">
                                 <i class="fa-solid fa-envelope me-2" style="font-size: 14px;"></i>{{$customer->email}}
                              </p>
                              <p class="card-p d-flex mb-2">
                                 <i class="fa-solid fa-map-pin me-2 pt-1" style="font-size: 14px;"></i>{{$customer->default_address}}
                              </p>
                              <hr class="my-3">
                              ...
                              <div class="amount">
                                 @foreach($services as $service)
                                    <p class="m-0 card-p">{{$service->name}}({{$service->quantity}})</p>
                              ...
                              <div class="driver mt-2">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-5">
                                       <p class="m-0">{{$lead->grand_total}}</p>
                                    </div>
                                 </div>
                              </div>
                           </div>
                    ...
                    <div class="col-md-3">
                      <div class="card card-link card-link-pop">
                        ...
                        <div class="card-body">
                          ...
                          <p class="card-p  d-flex align-items-center mb-2">
                            <i class="fa-solid fa-phone me-2" style="font-size: 14px;"></i>{{$customer->email}}
                            ...
                            <div class="tab-pane active show" id="tab-one" role="tabpanel">
                                <div class="row">
                                    ...
                                    <label for="radio-card-{{ $address->id }}" class="radio-card">
                                            <!-- {{ $lead->service_address }} | {{ $address->id }} -->
                                            <input type="radio" name="radio-card" id="radio-card-{{ $address->id }}"
                                              {{ $lead->service_address === $address->id ? 'checked' : '' }} 
                                              onclick="handleServiceAddressSelection({{ $address-> id}})">
                                                ...
                                                <div class="card-content-wrapper">
                                                    ...
                                                    <div class="card-content">
                                                        ...
                                                        <div class="form-check">
                                                            ...
                                                            <label class="form-check-label" for="flexRadioDefault-{{ $loop->index + 1 }}">Default Address</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </label>
  ...
  @foreach ($billingaddresses as $billingaddress)
    <div class="col-lg-4 col-md-4 col-sm-12">
      <!-- {{$lead->billing_address}} |{{$billingaddress->id}} -->
      <label for="radio-card-{{ $billingaddress->id }}" class="radio-card">
        <input type="radio" name="radio-card" id="radio-card-{{ $billingaddress->id }}" 
          {{ $lead->billing_address === $billingaddress->id ? 'checked' : '' }} onclick = handleBillingAddressSeletion({{ $billingaddress->id }})>
        <div class="card-content-wrapper">
          <span class="check-icon"></span>
          <div class="card-content">
            <h4>{{ $billingaddress->customer_name }}</h4>
            <p class="mb-1"><strong>Address:</strong> {{ $billingaddress->address }}</p>
            <p class="mb-1"><strong>Unit No:</strong> {{ $billingaddress->unit_no }}</p>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="flexRadioDefault"
                id="flexRadioDefault">
              <label class="form-check-label" for="flexRadioDefault{{ $billingaddress->id }}">
                Default Address
              </label>
            </div>
          </div>
                              ...
                              <div class="row mt-3">
                                 <div class="form-group col-lg-6 col-md-6 col-sm-12 text-start">
                                    ...
                                    <select class="form-control" name="deposite_type" id="deposite_type">
                                      <option>Select Option</option>
                                      <option value="$50" {{$lead->deposite_type == '$50' ? 'selected' : ''}}>$50</option>
                                      <option value="waive" {{ $lead->deposite_type == 'waive' ? 'selected' : '' }}>waive</option>
                                      <option value="Don’t need" {{ $lead->deposite_type == 'Don’t need' ? 'selected' : '' }}>Don’t need</option>

                                    </select>
                                 </div>
                                 <div class="form-group col-lg-6 col-md-6 col-sm-12 text-start">
                                    <label for="message-text" class="col-form-label">Date Of Cleaning</label>
                                    <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="cleaning_date" id="cleaning_date" value="{{$lead->date_of_cleaning}}">
                                 </div>
                                 <div class="form-group col-lg-6 col-md-6 col-sm-12 text-start">
                                    <label for="message-text" class="col-form-label">Time of Cleaning</label>
                                    <input type="time" class="form-control" placeholder="Time of Cleaning" name="cleaning_time" id="cleaning_time" value="{{$lead->time_of_cleaning}}">
                                 </div>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="card">
                        <div class="card-body">
                           <div id="advance_payment_fields" style="display: none;">
                              ...
                              <input type="number" name="advance_amount" id="advance_amount" class="form-control" value="{{$lead->advance_amount}}">
                           ...
                           <div id="full_payment_fields" style="display: none;">
                              ...
                              <input type="number" name="total_amount" id="total_amount" class="form-control" value="{{$lead->total_amount}}">
                                ...
                                <table class="table card-table table-vcenter text-center text-nowrap datatable">
                                  ...
                                  <tbody>
                                    <tr>
                                      <td>1</td>
                                      <td>Floor Cleaning</td>
                                      <td>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ducimus, sapiente.</td>
                                      <td>$308.00</td>
                                      <td>2</td>
                                      <td>0</td>
                                      <td>$308.00</td>
 ...
 <form id="service_address_form" method="POST">
         ...
         <div class="row my-3">
            ...
            <div class="col-md-4">
               <div class="form-group mb-3">
                  ...
                  <input type="text" placeholder="Enter Code" name="postal_code[]" onchange="handlePostalCodeLookup(this)" class="form-control postal_code"
                     >
               </div>
            </div>
            <div class="col-md-4">
      ...
      <table class="table card-table table-vcenter text-nowrap table-transparent" id="billing_address">
         ...
         <tbody>
            <tr>
               <td>
                  <input class="form-control postal_code" type="text" placeholder="Enter Code" name="b_postal_code[]" onchange="handlePostalCodeLookup(this)"/>
               </td>
               <td>
...
<script>
   $(function () {
       ...
       }); $('#billing_address').on('click', '.delete-row', function () { $(this).parent().parent().remove(); });
   })
</script>
<script>
...
<script>
   $(document).ready(function () {
     ...
     $(document).ready(function() {
            const paymentType = "{{$lead->payment_type}}";

    if (paymentType === "advance") {
      $("#payment_advance").prop("checked", true);
...
<script>
   ...
   $('#commercialList').empty().hide();
         ...
         if (customerId) {
            ...
            // If customerId is not available, set it to $lead->customer_id
            $('#customer_id_service').val("{{$lead->customer_id}}");
          }
   ...
   $.ajax({
      ...
      function handleServiceAddressSelection(addressId) {
        alert(`Selected Address ID HTML: ${addressId}`);
      }
      function handleBillingAddressSeletion(addressId){
        alert(`Selected Billing Address Id HTML: ${addressId}`);
      }
...
//   }
     ...
     <input type="text" class="form-control price" value="${serviceName}" name="service_name[]">
      ...
      <td class="description-cell" data-full-text="${serviceDescription}">${serviceDescription}</td>
       ...
       <td><input type="number" class="form-control discount-input" placeholder = "discount"></td>
       <td><input type="number" class="form-control" placeholder = "Gross Amount"></td>
       <td>
...
$('.service-id').val(serviceId);
 const serviceIdsInput = $('input[name="service_ids"]');
   ...
   const updatedServiceDescription = currentServiceDescription ? `${currentServiceDescription},${serviceDescription}` : serviceDescription;
   serviceDescriptionsInput.val(updatedServiceDescription);

  const currentServiceUnitPrice = unitPriceInput.val();
   const updatedServiceUnitPrice = currentServiceUnitPrice ? `${currentServiceUnitPrice},${servicePrice}` : servicePrice;
   ...
   const currentSelectedServices = selectedServicesInput.val();
     const updatedSelectedServices = currentSelectedServices ? `${currentSelectedServices},${serviceId}` : serviceId;
...
<script>
$(document).ready(function() {
    const leadScheduleDate = "{{$lead->schedule_date}}";
    ...
    $('#calendar').datepicker({
        ...
        beforeShowDay: function(date) {
            ...
            if (formattedSelectedDate === leadScheduleDate) {
        ...
        onSelect: function (dateText, inst) {
            ...
            if (selectedDay + '/' + selectedMonth + '/' + selectedYear === leadScheduleDate) {
                console.log('Selected date matches highlight date.');
            } else {
                console.log('Selected date does not match highlight date.');
            }
        }
    });
});
