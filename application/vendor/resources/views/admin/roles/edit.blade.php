                    ...
                    <div class="card-header">
                      <div class="text-muted">
                        <div class="col-lg-12 margin-tb">
                          <div class="pull-left">
                            <h2>Edit {{ ucfirst($role->name) }} Role</h2>
                          </div>
                        </div>
                      </div>
                    </div>
                            ...
                            <ul id="bs_main" class="main_ul">
                              <li id="bs_1">
                                ...
                                <ul id="bf_l_1" style="display: none" class="inner_ul">
                                      <li id="io_1">
                                      <input type="checkbox" id="c_io_1" name="permission[]" value="1" {{ in_array(1, $rolePermissions) ? 'checked' : '' }}>
                                        <span>role-list</span>
                                      </li>
                                      <li id="io_2">
                                        <input type="checkbox" id="c_io_2" name="permission[]" value="2" {{ in_array(2, $rolePermissions) ? 'checked' : '' }}/>
                                        <span>role-create </span>
                                      </li>
                                      <li id="io_3">
                                        <input type="checkbox" id="c_io_3" name="permission[]" value="3" {{ in_array(3, $rolePermissions) ? 'checked' : '' }}/>
                                        <span>role-edit </span>
                                      </li>
                                      <li id="io_4">
                                        <input type="checkbox" id="c_io_4" name="permission[]" value="4" {{ in_array(4, $rolePermissions) ? 'checked' : '' }}/>
...
<ul id="bf_l_2" style="display: none" class="inner_ul">
                                      <li id="io_5">
                                        <input type="checkbox" id="c_io_5" name="permission[]" value="5" {{ in_array(5, $rolePermissions) ? 'checked' : '' }}/>
                                        <span>product-list </span>
                                      </li>
                                      <li id="io_6">
                                        <input type="checkbox" id="c_io_6" name="permission[]" value="6" {{ in_array(6, $rolePermissions) ? 'checked' : '' }}/>
                                        <span>product-create </span>
                                      </li>
                                      <li id="io_7">
                                        <input type="checkbox" id="c_io_7" name="permission[]" value="7" {{ in_array(7, $rolePermissions) ? 'checked' : '' }}/>
                                        <span>product-edit </span>
                                      </li>
                                      <li id="io_8">
                                        <input type="checkbox" id="c_io_8" name="permission[]" value="8" {{ in_array(8, $rolePermissions) ? 'checked' : '' }}/>
