        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new Calendar(calendarEl, {
                ...
                resourceLabelContent: function(arg) {
                    ...
                    const customHtml = `<div class="fc-datagrid-cell-cushion fc-scrollgrid-sync-inner cleaner_class"
                ...
                drop: function(info) {
                    ...
                    eventUpdate(sales_order_id, customerID, empId, dataDate, startTime, resourceType, newdate,
                        Service_Details);
                ...
                eventResize: function(info) {
                    ...
                    eventTimeUpdate(startTime, endTime, empId, schedule_id);
            ...
            function eventTimeUpdate(startTime, endTime, empId, schedule_id) {
                $.ajax({
                    type: 'POST',
                    url: '{{ route('schedule.event.update') }}',
                    data: {
