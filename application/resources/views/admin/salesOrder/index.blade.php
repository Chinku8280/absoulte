                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="tab-content mt-3">
                                    @foreach ($company as $comp_key => $comp_item)
                                        <div class="tab-pane fade {{ $comp_key == 0 ? 'active show' : '' }}" id="company_{{ $comp_item->id }}" role="tabpanel">
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="table-responsive" style="min-height: 500px;">                                                       
                                                        {{-- <table id="order_table" class="table card-table table-vcenter text-center text-nowrap datatable" style="width: 100%;"> --}}
                                                        <table class="table text-left order_table" id="order_table_{{$comp_item->id}}" style="width: 100%;">
                                                            <thead>
                                                                <tr>
                                                                    <th class="w-1">No.</th>
                                                                    <th>Invoice No.</th>
                                                            ...
                                                            <tbody>
                                                                @foreach($salesOrderGroupedByCompany[$comp_item->id] ?? [] as $key => $item)
                                                                    <tr>
                                                                        <td>{{ $key + 1 }}</td>
