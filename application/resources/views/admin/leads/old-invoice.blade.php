    ...
    <table>
        <tr>
            ...
            <td style="width: 33.33%;">
                <table>
                    <tr>
                        <td style="text-align: end; font-size: 16px;"><b>QUOTATION</b></td>
                    </tr>
                    <tr>
                        <td class="p-0"><b>Quotation No:</b></td>
                        <td class="p-0">{{ $quotation->quotation_no }}</td>
                    </tr>
                    <tr>
