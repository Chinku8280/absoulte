...
<div class="modal-body">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" placeholder="Enter Name"
                                                        name="person_incharge_name[]" class="form-control person_incharge_name">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                        ...
                                        <div class="row my-3 service_addr_group">
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    <label for="name">Person Incharge Name</label>
                                                    <input type="text" placeholder="Enter Name"
                                                        name="c_person_incharge_name[]" class="form-control c_person_incharge_name">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    <label for="name">Contact No</label>
                                                    <input type="text" placeholder="Enter Number"
                                                        name="c_contact_no[]" class="form-control c_contact_no" required="">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" placeholder="Enter Email" name="c_email_id[]"
                                                        class="form-control c_email_id" required="">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
        ...
        function handlePostalCode(element) {
            ...
            $.ajax({
                ...
                success: function(JSON) {
                    ...
                    $(element).parents('.billing_addr_group').find('.bill_address').val(JSON.results[0]
                    .ADDRESS);
    ...
    <script>
        $(document).ready(function() {
            ...
            //                 var fullAddress = firstResult.ADDRESS;
    ...
    <script>
        $(document).ready(function() {
            // Add row
            $('body').on('click', '.add-row-contact', function() {
            ...
            $('body').on('click', '.add-row-contact2', function() {
    ...
    <script>
        $(document).ready(function () {
            ...
            $('body').on('change', '#same_address_res', function(){               
                ...
                if($(this).is(':checked'))
                {
                    var size = $("#residential_customer_form #res_newinput").find(".service_addr_group").length;

                    if(size > 0)
                    {
                        $('#residential_customer_form #res_newInput_bill').html("");

                        var el = $("#residential_customer_form #res_newinput .service_addr_group");
                        ...
                        for(var i=0; i<size; i++)
                        {
                            ...
                            $('#residential_customer_form #res_newInput_bill').append(html);
                        }
                    }
                }
                else
            ...
            $('body').on('change', '#same_address_com', function(){               
                ...
                if($(this).is(':checked'))
                {
                    var size = $("#commercial_customer_form #com_newinput").find(".service_addr_group").length;

                    if(size > 0)
                    {
                        $('#commercial_customer_form #com_newInput_bill').html("");

                        var el = $("#commercial_customer_form #com_newinput .service_addr_group");
                        ...
                        for(var i=0; i<size; i++)
                        {
                            ...
                            $('#commercial_customer_form #com_newInput_bill').append(html);
                        }
                    }
                }
                else
