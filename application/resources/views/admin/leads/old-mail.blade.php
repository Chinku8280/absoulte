...
<div class="container">
    ...
    <p>{{ $body }}</p>
    <a href="{{ $data['payment_link']->getOriginalContent()['payment_link'] }}">Click here to make the payment</a>
    <p>Regards,{{ $company_name }}<br></p>

    <div class="confirm-button center">
        <a href="{{ env('APP_URL') }}/mail/confirm/{{ $lead_id }}" class="btn btn-info"
            id="confirmButton">Confirm</a>
        <a href="#" class="btn btn-danger">Cancel</a>
        {{-- <p>Hello {{ $customer->name }},</p>
        <p>Click the following link to make a payment:</p>
    <a href="{{ $paymentData['paymentUrl'] }}">{{ $paymentData['paymentUrl'] }}</a> --}}
    </div>
</div>
