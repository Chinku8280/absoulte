...
<div class="modal-header">
    <h5 class="modal-title">Lead Send Payment Advice</h5>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="col-md-6">
                                        ...
                                        <input type="hidden" value="{{$lead->grand_total}}" id="payment_amount" name="payment_amount">
                                    </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4 text-center">
                                                        <h2>{{ucfirst($lead->payment_status)}}</h2>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-8"></div>
                                                    ...
                                                    <div class="col-7 col-sm-7">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-4 col-md-4 text-start">
                                                                <div class="fs-12 lh-13">{{Auth::user()->first_name . " " . Auth::user()->last_name}}</div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-8 col-md-8 text-end">
                                                            ...
                                                            <div class="col-4 col-md-4 text-start">
                                                                <div class="fs-12 lh-13">{{$lead->temp_invoice_no}}</div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-8 col-md-8 text-end">
                                                        ...
                                                        @if (!empty($lead->schedule_date))
                                                            <div class="row">
                                                                ...
                                                                <div class="col-4 col-md-4 text-start">
                                                                    <div class="fs-12 lh-13">{{ ($lead->schedule_date)?date('d-m-Y', strtotime($lead->schedule_date)):'' }}</div>
                                                                </div>
                                                            </div>
                                                        @endif
                                                        ...
                                                        <div class="row mb-2">
                                                            ...
                                                            <div class="col-8 col-md-8 text-start">
                                                                <div>
                                                                    ...
                                                                    @php
                                                                        $remark_arr = explode(PHP_EOL, $lead->remarks)                                                  
                                                                    @endphp
                                                            ...
                                                            <div class="col-4 col-md-4 text-end">
                                                                <div>
                                                                    <div class="d-flex justify-content-between fs-10 lh-13">
                                                                        $<div id="preview_tax_amt">{{number_format($lead->tax, 2)}}</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-4 col-md-4 text-end">
                                                                <div>
                                                                    <div
                                                                        class="d-flex justify-content-between fs-10 lh-13">
                                                                        $<div id="preview_grand_total" data-preview_grand_total="{{$lead->grand_total}}">{{number_format($lead->grand_total, 2)}}</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row" style="display: none;" id="preview_balance_amount_group">
                                                            ...
                                                            <div class="col-4 col-md-4 text-end">
                                                                <div>
                                                                    <div
                                                                        class="d-flex justify-content-between fs-10 lh-13">
                                                                        $<div id="preview_balance_amount">{{number_format($lead->grand_total, 2)}}</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
...
<script>
    ...
    function findTemplateId() 
    {
        ...
        var invoice_no = "{{$lead->temp_invoice_no}}";
        var new_schedule_date = "{{ $lead->schedule_date ? date('d-m-Y', strtotime($lead->schedule_date)) : ''}}";
        var quotation_no = "{{$lead->quotation_no}}";
    ...
    function emailSend(event) 
    {
        ...
        {
            $.ajax({
                url: '{{ route('lead.process.payment') }}',
                method: 'POST',
        ...
        else
        {
            ...
            $.ajax({
                url: "{{ route('lead.send-payment.offline') }}",
                method: 'POST',
                data: data,
                processData: false,
                contentType: false,
    ...
    function view_download_payment_advice_pdf(event) 
    {
        ...
        $.ajax({
            url: "{{ route('lead.payment-advice.view-pdf') }}",
            method: 'POST',
            data: $("#lead_form").serialize(),
            success: function(response) {
                console.log(response);
    ...
    function confirm_payment_advice(event)
    {
        ...
        $.ajax({
            url: "{{ route('lead.send-payment-advice.confirm') }}",
            method: 'POST',
            data: $("#lead_form").serialize(),
