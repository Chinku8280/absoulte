<div class="row">
                                    ...
                                    @if (!empty($quotation))                                                                     
                                        <div class="row">
                                            ...
                                            <div class="col-4 col-md-4 text-start">
                                                <div class="fs-12 lh-13 print_file_name preview_quotation_no" id="preview_quotation_no">{{ $quotation->quotation_no ?? '' }}</div>
                                            </div>
                                        </div>
                                    @endif
                                ...
                                <div class="col-7 col-sm-7">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-8 col-md-8 text-start">
                                            <div class="fs-10 lh-13" id="preview_remarks">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-9 col-md-9 text-start">
                                            <div class="fs-10 lh-13">
                                                @php
                                                    $paymentTerm = App\Models\PaymentTerms::find(
                                                        $customer->payment_terms,
                                                    );
                                                @endphp
                                                {{ $paymentTerm ? $paymentTerm->payment_terms : 'Unknown Payment Term' }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
    ...
    <div class="d-flex">
        ...
        <div style="width: 100%; text-align: end;">
            <button type="button" class="btn btn-info w-100 mt-3" data-dismiss="modal" onclick="confirm_btn()"
