                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive" style="min-height: 500px;">
                                    <table class="table card-table table-vcenter text-left text-nowrap datatable" id="finance_table">
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var finance_table = $('#finance_table').DataTable({
                "lengthChange": false,
                "pageLength": 30,
                ajax: {
                    url: "{{ route('finance.get-table-data') }}",
                    type: 'GET'
                },
                'columnDefs': [{
