...
<body>
    <table style="width: 100%;">
        <tr>
            ...
            <td style="width: 80%; vertical-align: middle;">
                ...
                <p class="fs-12 lh-13">Tel: +65 {{$company->telephone}} Fax: +65 {{$company->fax}} Phone: +65 {{$company->contact_number}}</p>
                ...
                <table>
                    ...
                    @if (!empty($quotation->schedule_date))
                        <tr>
                            ...
                            <td class="p-0">{{ ($quotation->schedule_date)?date('d-m-Y', strtotime($quotation->schedule_date)):'' }}</td>
                        </tr>
                    @endif
                </table>
            </td>
    ...
    <table class="invoice-table table" style="border-bottom: 1px solid #000; width: 100%;">
        <thead>
            <tr>
                {{-- <th>PRODUCT CODE</th> --}}
                <th>Sl NO.</th>
            ...
            @foreach ($quotation_details as $key => $item)
                <tr>
                    ...
                    <td>
                        ...
                        @if ($schedule)
                            <div>Time: {{$schedule->cleaning_time ?? ''}}</div>
                            <div>No of Cleaners: {{$schedule->no_of_cleaners ?? ''}}</div>
                            <div>Every: {{$schedule->new_selected_days ?? ''}}</div>
                            <div>Time: {{$schedule->new_cleaning_dates ?? ''}}</div>
                        @endif
            ...
            <td style="width: 50%;">
                <table>
                    ...
                    <tr>
                        ...
                        <td style="width: 60%; text-align: start; font-size: 10px; line-height: 1.2;">{{$customer->payment_terms_value}}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="width: 40%; text-align: start; font-size: 10px; line-height: 1.2;">Payment Method:</td>
                        <td style="width: 60%; text-align: start; font-size: 10px; line-height: 1.2;">
                            {{-- <span>PayNow</span>  --}}
            ...
            <td style="width: 30%;">
                <table>
                    ...
                    <tr>
                        ...
                        <td style="width: 33.333%; text-align: end; font-size: 10px; line-height: 1.2;">
                            $&nbsp;{{ number_format($quotation->discount_amt, 2) }}</td>
                    </tr>
                    <tr>
