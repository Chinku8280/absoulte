                    ...
                    <div class="col-lg-12 col-md-6 col-sm-1">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="company">
                                    ...
                                    <option value="{{ $list->id }}" {{ $list->id == $data->company ? 'selected' : '' }}>
                                    {{ $list->company_name }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="service_name"
                                    placeholder="Enter Name" value="{{$data->service_name}}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Man Power Required</label>
                                <input type="text" class="form-control" name="man_power_required"
                                    placeholder="Enter length" value="{{$data->man_power}}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Product Code</label>
                                <input type="text" class="form-control" name="product_code"
                                    placeholder="Enter length" value="{{$data->product_code}}">
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Hour/Session</label>
                                        <input type="text" class="form-control" name="hour_session" value="{{$data->hour_session}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Weekly Freq</label>
                                        <input type="text" class="form-control" name="weekly_freq" value="{{$data->weekly_freq}}">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Total Sessions</label>
                                <input type="text" class="form-control" name="total_session" value="{{$data->total_session}}">
                            </div>
                            <div class="mb-3">
