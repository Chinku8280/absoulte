...
<div class="modal-body">
                                        ...
                                        <div class="row my-3">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" placeholder="Enter Email" name="email_id[]"
                                                        class="form-control" value="{{ $address->email_id ?? '' }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" placeholder="Enter Code"
                                                        name="postal_code_service[]" class="form-control postal-code"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" placeholder="Enter Zone" name="zone_service[]"
                                                        class="form-control" value="{{ $address->zone ?? '' }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" placeholder="Enter Address"
                                                        name="address_service[]" class="form-control address"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" value="{{ $address->postal_code ?? '' }}"
                                                        name="postal_code_bill[]" class="form-control postal-code"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" value="{{ $address->address ?? '' }}"
                                                        name="address_bill[]" class="form-control bill_address">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group mb-3">
                ...
                <div class="col-lg-4 col-md-6 col-sm-1">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="individual_company_name"
                            value="{{ $data->individual_company_name }}" placeholder="Individual Company Name">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-1">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="mobile_number"
                            value="{{ $data->mobile_number }}" placeholder="Enter Number">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-1">
                    <div class="mb-3">
                                        ...
                                        <div class="row my-3">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    <label for="name">Address</label>
                                                    <input type="text" placeholder="Enter Address"
                                                        name="c_address[]" class="form-control address"
                                                        value="{{ $address->address }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="row my-3" id="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    <label for="name">Address</label>
                                                    <input type="text" value="{{ $address->address ?? '' }}"
                                                        name="c_address_bil[]" class="form-control bill_address">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group mb-3">
    ...
    <script>
       ...
       <div class="col-md-4">
         <div class="form-group mb-3">
           <label for="name">Postal Code</label>
           <input type="text" placeholder="Enter Code" name="c_postal_code_bil[]" class="form-control postal-code" onchange="handlePostalCode(this)">
         </div>
       </div>
       <div class="col-md-4">
         <div class="form-group mb-3">
