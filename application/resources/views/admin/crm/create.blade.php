            ...
            <div class="row">
                        ...
                        <div class="dropdown" data-control="checkbox-dropdown">
                            ...
                            <div class="dropdown-list">
                                ...
                                @foreach ($service_type as $item)
                                    <label class="dropdown-option">
                                        <input type="checkbox" name="cleaning_type[]" value="{{$item->id}}" />
                                        {{$item->service_type}}
                                    </label>
                                @endforeach
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="mb-3">
                        ...
                        <input type="number" name="pending_invoice_limit" id="res_pending_invoice_limit" class="form-control" min="0" value="4">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="mb-3">
                        <label class="form-label" for="res_renewal">Sales Order Renewal</label>
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" name="renewal" id="res_renewal" checked>
                            {{-- <label class="form-check-label" for="res_renewal">Sales Order Renewal</label> --}}
                        </div>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div id="showTwo" class="myDiv" style="display: none;">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="mb-3">
                        <label class="form-label">Pending Invoices Limit</label>
                        <input type="number" name="pending_invoice_limit" id="com_pending_invoice_limit" class="form-control" min="0" value="4">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="mb-3">
                        <label class="form-label" for="com_renewal">Sales Order Renewal</label>
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" name="renewal" id="com_renewal" checked>
                            {{-- <label class="form-check-label" for="com_renewal">Sales Order Renewal</label> --}}
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $('#same_address_res').change(function(){

        if($(this).is(':checked'))
        {
            var size = $("#add-crm-modal #residential_customer_form #res_newinput").find(".service_addr_group").length;

            if(size > 0)
            {
                $('#add-crm-modal #residential_customer_form #res_newInput_bill').html("");

                var el = $("#add-crm-modal #residential_customer_form #res_newinput .service_addr_group");
                ...
                for(var i=0; i<size; i++)
                {
                    ...
                    $('#add-crm-modal #residential_customer_form #res_newInput_bill').append(html);
                }
            }
        }
        else
    ...
    $('#same_address_com').change(function(){

        if($(this).is(':checked'))
        {
            var size = $("#add-crm-modal #commercial_customer_form #com_newinput").find(".service_addr_group").length;

            if(size > 0)
            {
                $('#add-crm-modal #commercial_customer_form #com_newInput_bill').html("");

                var el = $("#add-crm-modal #commercial_customer_form #com_newinput .service_addr_group");
                ...
                for(var i=0; i<size; i++)
                {
                    ...
                    $('#add-crm-modal #commercial_customer_form #com_newInput_bill').append(html);
                }
            }
        }
        else
    ...
    $('#res_customer_name').blur(function(){
    ...
    $('#com_customer_name').blur(function(){
