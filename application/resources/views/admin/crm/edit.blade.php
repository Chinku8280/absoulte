...
<div class="modal-body">
    <div class="mb-3">
        ...
        <select class="form-select" id="myselection">
            ...
            <option value="One" {{ $data->customer_type == 'residential_customer_type' ? 'selected' : 'disabled' }}>
                Residential</option>
            <option value="Two" {{ $data->customer_type == 'commercial_customer_type' ? 'selected' : 'disabled' }}>Commercial
            </option>
        </select>
    </div>

    @if ($data->customer_type == 'residential_customer_type')
        @php
            $com_display = "display: none";
            $res_display = "";
        @endphp
    @elseif ($data->customer_type == 'commercial_customer_type')
        @php
            $res_display = "display: none";
            $com_display = "";
        @endphp
    @endif
    ...
    <form id="residential_customer_form" method="POST">
        ...
        <div id="showOne" class="row myDiv" style="{{$res_display}}">
            <div class="row">
                        ...
                        <div class="input-group">
                            <select class="form-select" name="saluation"
                                ...
                                @foreach ($salutation_data as $item)
                                    <option value="{{$item->id}}" {{ $data->saluation == $item->id ? 'selected' : '' }}>{{$item->salutation_name}}</option>
                                @endforeach
                            </select>
                            <input type="text" class="form-control w-50" name="customer_name"
                                value="{{ $data->customer_name }}" placeholder="Enter Name" id="edit_res_customer_name">
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="contact_no" value="{{ $data->mobile_number }}"
                            placeholder="Enter Number" id="edit_res_contact_no">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="email" value="{{ $data->email }}"
                            placeholder="Enter Email" id="edit_res_email">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="mb-3">
                            ...
                            <div class="dropdown-list">
                                ...
                                {{-- <label class="dropdown-option">
                                    <input type="checkbox" name="cleaning_type[]" value="Floor Cleaning"
                                       @if(in_array('Floor Cleaning', $data['cleaningTypes'])) {{'checked'}} @endif >
                                    Floor Cleaning
                                </label>
                                <label class="dropdown-option">
                                    <input type="checkbox" name="cleaning_type[]" value="Home Cleaning"                                    
                                        @if(in_array('Home Cleaning', $data['cleaningTypes'])) {{'checked'}} @endif>
                                    Home Cleaning
                                </label>
                                <label class="dropdown-option">
                                    <input type="checkbox" name="cleaning_type[]" value="Office Cleaning"                                     
                                        @if(in_array('Office Cleaning', $data['cleaningTypes'])) {{'checked'}} @endif>
                                    Office Cleaning
                                </label> --}}

                                @foreach ($service_type as $item)
                                    <label class="dropdown-option">
                                        <input type="checkbox" name="cleaning_type[]" value="{{$item->id}}" @if(in_array($item->id, $data['cleaningTypes'])) {{'checked'}} @endif>
                                        {{$item->service_type}}
                                    </label>
                                @endforeach
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="mb-3">
                        ...
                        <select name="lead_source" id="lead_source" class="form-select">
                            ...
                            <option value="{{ $source->source_name }}" {{ $source->source_name == $data->lead_source ? 'selected' : '' }}>
                                {{ $source->source_name }}
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="mb-3">
                        ...
                        <input type="number" name="pending_invoice_limit" id="edit_res_pending_invoice_limit" class="form-control" min="0" value="{{$data->pending_invoice_limit}}">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="mb-3">
                        <label class="form-label" for="edit_res_renewal">Sales Order Renewal</label>
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" name="renewal" id="edit_res_renewal" {{($data->renewal == 1) ? 'checked' : ''}}>
                            {{-- <label class="form-check-label" for="edit_res_renewal">Sales Order Renewal</label> --}}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="mb-3">
                        ...
                        {{-- <input type="text" class="form-control" name="customer_remark"
                            value="{{ $data->customer_remark }}" placeholder="Enter Remarks"> --}}

                        <textarea class="form-control" name="customer_remark" placeholder="Enter Remarks" cols="30" rows="5">{{ $data->customer_remark }}</textarea>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active show" id="tabs-1" role="tabpanel">
                                    <div class="row mb-2">
                                        <div class="col-lg-2">
                                            ...
                                            <a href="#" class="btn btn-primary res-add-row-contact" onclick="res_add_row_contact(this)">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5 col-md-5 col-sm-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        name="edit_res_additional_contact_name[]" placeholder="Enter Name"
                                            ...
                                            <div class="col-lg-5 col-md-5 col-sm-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        name="edit_res_additional_mobile_number[]"
                                            ...
                                            <div class="col-lg-5 col-md-5 col-sm-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" class="form-control"
                                                        name="edit_res_additional_email[]" placeholder="Enter Email" value="{{ $contact->email }}">
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach                                       
                                    <div id="edit-res-additional-rows"></div>
                                </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" name="info_payment_terms">
                                                            @foreach ($payment_terms as $list)
                                                                <option value="{{ $list->id }}"
                                                                    {{ $additional_info && $list->id == $additional_info->payment_terms ? 'selected' : '' }}>
                                                                    {{ $list->payment_terms ?? '' }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                {{-- <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" name="info_status">
                                                            <option value="1"
                                                                {{ $additional_info && $additional_info->status == '1' ? 'selected' : '' }}>
                                                                Active</option>
                                                            <option value="2"
                                                                {{ $additional_info && $additional_info->status == '2' ? 'selected' : '' }}>
                                                                Inactive</option>
                                                            <option value="3"
                                                                {{ $additional_info && $additional_info->status == '3' ? 'selected' : '' }}>
                                                                Block</option>
                                ...
                                <div class="tab-pane" id="tabs-3" role="tabpanel">
                                    ...
                                    <div id="res_newinput">
                                        @foreach ($service_address as $key => $address)
                                            <div class="row my-3 service_addr_group">
                                                <input type="hidden" name="edit_resd_serv_address_id[]" class="edit_resd_serv_address_id" value="{{ $address->id ?? '' }}">

                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="name">Person Incharge Name</label>
                                                        <input type="text" placeholder="Enter Name"
                                                            name="edit_resd_serv_person_incharge_name[]" class="form-control person_incharge_name"
                                                            value="{{ $address->person_incharge_name ?? '' }}" id="{{($key==0)?'edit_res_serv_addr_pi_name':''}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Enter Number"
                                                            name="edit_resd_serv_phone_no[]" class="form-control phone_no"
                                                            value="{{ $address->contact_no ?? '' }}" id="{{($key==0)?'edit_res_serv_addr_pi_no':''}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="name">Email Id</label>
                                                        <input type="text" placeholder="Enter Email" name="edit_resd_serv_email_id[]"
                                                            class="form-control email_id" value="{{ $address->email_id ?? '' }}" id="{{($key==0)?'edit_res_serv_addr_pi_email':''}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Enter Code"
                                                            name="edit_resd_serv_postal_code[]" class="form-control postal-code"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Enter Zone" name="edit_resd_serv_zone[]"
                                                            class="form-control zone" value="{{ $address->zone ?? '' }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Enter Unit No."
                                                            name="edit_resd_serv_unit_number[]" class="form-control unit_number_service"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <textarea placeholder="Enter Address" name="edit_resd_serv_address[]" class="form-control address">{{ $address->address ?? '' }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Enter Territory."
                                                            name="edit_resd_serv_territory[]" class="form-control territory"
                                ...
                                <div class="tab-pane" id="tabs-4" role="tabpanel">
                                    ...
                                    <div id="res_newInput_bill">
                                        @foreach ($billing_address as $key => $address)
                                            <input type="hidden" name="edit_resd_bill_address_id[]" value="{{ $address->id ?? '' }}">

                                            <div class="row my-3 billing_addr_group" id="row">
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="name">Person Incharge Name</label>
                                                        <input type="text"
                                                            value="{{ $address->person_incharge_name ?? '' }}"
                                                            name="edit_resd_bill_person_incharge_name[]" class="form-control" id="{{($key==0)?'edit_res_bill_addr_pi_name':''}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" value="{{ $address->contact_no ?? '' }}"
                                                            name="edit_resd_bill_phone_no[]" class="form-control" id="{{($key==0)?'edit_res_bill_addr_pi_no':''}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="email" value="{{ $address->email ?? '' }}"
                                                            name="edit_resd_bill_email[]" class="form-control" id="{{($key==0)?'edit_res_bill_addr_pi_email':''}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" value="{{ $address->postal_code ?? '' }}"
                                                            name="edit_resd_bill_postal_code[]" class="form-control postal-code"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" value="{{ $address->unit_number ?? '' }}"
                                                            name="edit_resd_bill_unit_number[]" class="form-control"
                                                            required="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group mb-3">
                                                        <label for="name">Address</label>
                                                        <textarea name="edit_resd_bill_address[]" class="form-control bill_address">{{ $address->address ?? '' }}</textarea>
                                                    </div>
                                                </div>

                                                <input type="hidden" name="edit_resd_bill_zone[]" class="zone" value="{{ $address->zone ?? '' }}">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="edit_residential_customer_form_btn">Save
                    changes</button>
            </div>
        </div>
    </form>
    ...
    <form id="commercial_customer_form" method="POST">
        ...
        <div id="showTwo" class="myDiv" style="{{$com_display}}">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="mb-3">
                        <label class="form-label">Customer Name<span class="text-danger">*</span></label>
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control w-50" name="customer_name"
                                value="{{ $data->customer_name }}" placeholder="Enter Name" id="edit_com_customer_name">
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                ...
                {{-- <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="group_company_name"
                            value="{{ $data->group_company_name }}" placeholder="Group Company Name">
                    </div>
                </div> --}}
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="mb-3">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="mobile_number"
                            value="{{ $data->mobile_number }}" placeholder="Enter Number" id="edit_com_contact_no">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="mb-3">
                        <label class="form-label">Email</label>
                        <input type="text" class="form-control" name="email" value="{{ $data->email }}"
                            placeholder="Enter Email" id="edit_com_email">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="mb-3">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="mb-3">
                        <label class="form-label">Language Spoken</label>
                        <select type="text" class="form-select" id="spoken_language" value=""
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="mb-3">
                        <label class="form-label">Pending Invoices Limit</label>
                        <input type="number" name="pending_invoice_limit" id="edit_com_pending_invoice_limit" class="form-control" min="0" value="{{$data->pending_invoice_limit}}">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="mb-3">
                        <label class="form-label" for="edit_com_renewal">Sales Order Renewal</label>
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" name="renewal" id="edit_com_renewal" {{($data->renewal == 1) ? 'checked' : ''}}>
                            {{-- <label class="form-check-label" for="edit_com_renewal">Sales Order Renewal</label> --}}
                        </div>
                    </div>
                </div>
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6 col-sm-1">
                                            <div class="mb-3">
                                                <label class="form-label">Contact Name </label>
                                                <input type="text" class="form-control"
                                                    name="company_contact_name" placeholder="Enter Name" id="edit_comp_info_contact_name"
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-1">
                                            <div class="mb-3">
                                                <label class="form-label">Mobile Number</label>
                                                <input type="text" class="form-control" name="company_mobile_no" id="edit_comp_info_company_mobile_no"
                                                    placeholder="Enter Number"
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-1">
                                            <div class="mb-3">
                                                <label class="form-label">Email</label>
                                                <input type="text" class="form-control" name="company_email" id="edit_comp_info_company_email"
                                ...
                                <div class="tab-pane" id="tabs-01" role="tabpanel">
                                    <div class="row mb-2">
                                        <div class="col-lg-2">
                                            {{-- <label class="form-label" style="visibility: hidden;">Add</label> --}}
                                            <a href="#" class="btn btn-primary com-add-row-contact2" onclick="com_add_row_contact(this)">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5 col-md-5 col-sm-12">
                                                <div class="mb-3">
                                                    <label class="form-label">Contact Name</label>
                                                    <input type="text" class="form-control"
                                                        name="edit_com_additional_contact_name[]" placeholder="Enter Name"
                                                        value="{{ $contact->contact_name }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-5 col-md-5 col-sm-12">
                                                <div class="mb-3">
                                                    <label class="form-label">Mobile Number</label>
                                                    <input type="text" class="form-control"
                                                        name="edit_com_additional_mobile_no[]" placeholder="Enter Number"
                                                        value="{{ $contact->mobile_no }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-5 col-md-5 col-sm-12">
                                                <div class="mb-3">
                                                    <label class="form-label">Email</label>
                                                    <input type="email" class="form-control"
                                                        name="edit_com_additional_email[]" placeholder="Enter Email" value="{{ $contact->email }}">
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach                                       
                                    <div id="edit-com-additional-rows"></div>
                                </div>
                                ...
                                <div class="tab-pane" id="tabs-03" role="tabpanel">
                                    <button type="button" class="btn btn-blue" id="rowAdder-2">+ Add Address</button>

                                    <div id="com_newinput">
                                        @foreach ($service_address as $key => $address)
                                            <div class="row my-3 service_addr_group">
                                                <input type="hidden" name="edit_com_serv_address_id[]" class="edit_com_serv_address_id" value="{{ $address->id ?? '' }}">

                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="name">Person Incharge Name </label>
                                                        <input type="text" placeholder="Enter Name"
                                                            name="edit_com_serv_person_incharge_name[]" class="form-control c_person_incharge_name"
                                                            value="{{ $address->person_incharge_name }}" id="{{($key==0)?'edit_com_serv_addr_pi_name':''}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="name">Contact No</label>
                                                        <input type="text" placeholder="Enter Number"
                                                            name="edit_com_serv_contact_no[]" class="form-control c_contact_no"
                                                            value="{{ $address->contact_no }}" id="{{($key==0)?'edit_com_serv_addr_pi_no':''}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Enter Email"
                                                            name="edit_com_serv_email_id[]" class="form-control c_email_id"
                                                            value="{{ $address->email_id }}" id="{{($key==0)?'edit_com_serv_addr_pi_email':''}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="name">Postal Code</label>
                                                        <input type="text" placeholder="Enter Code"
                                                            name="edit_com_serv_postal_code[]" class="form-control postal-code"
                                                            onchange="handlePostalCodeLookup(this)"
                                                            value="{{ $address->postal_code }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="name">Zone</label>
                                                        <input type="text" placeholder="Enter Zone" name="edit_com_serv_zone[]"
                                                            class="form-control zone" value="{{ $address->zone }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="name">Unit No</label>
                                                        <input type="text" placeholder="Enter Unit No."
                                                            name="edit_com_serv_unit_no[]" class="form-control c_unit_no"
                                                            value="{{ $address->unit_number }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group mb-3">
                                                        <label for="name">Address</label>
                                                        <textarea placeholder="Enter Address" name="edit_com_serv_address[]" class="form-control address">{{ $address->address }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="name">Territory</label>
                                                        <input type="text" placeholder="Enter Unit No."
                                                            name="edit_com_serv_territory[]" class="form-control territory"
                                                            value="{{ $address->territory }}">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div id="com_newInput_bill">
                                        @foreach ($billing_address as $key => $address)
                                            <div class="row my-3 billing_addr_group" id="row">
                                                ...
                                                <input type="hidden" name="edit_com_bill_address_id[]" value="{{ $address->id ?? '' }}">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text"
                                                            value="{{ $address->person_incharge_name ?? '' }}"
                                                            name="edit_com_bill_person_incharge_name[]" class="form-control" id="{{($key==0)?'edit_com_bill_addr_pi_name':''}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="name">Contact No</label>
                                                        <input type="text" value="{{ $address->contact_no ?? '' }}"
                                                            name="edit_com_bill_contact_no[]" class="form-control" id="{{($key==0)?'edit_com_bill_addr_pi_no':''}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="name">Email</label>
                                                        <input type="email" value="{{ $address->email ?? '' }}"
                                                            name="edit_com_bill_email[]" class="form-control" id="{{($key==0)?'edit_com_bill_addr_pi_email':''}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="name">Postal Code</label>
                                                        <input type="text" value="{{ $address->postal_code ?? '' }}"
                                                            name="edit_com_bill_postal_code[]" class="form-control postal-code"
                                                            onchange="handlePostalCode(this)">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="name">Unit No</label>
                                                        <input type="text" value="{{ $address->unit_number ?? '' }}"
                                                            name="edit_com_bill_unit_no[]" class="form-control" required="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group mb-3">
                                                        <label for="name">Address</label>
                                                        <textarea name="edit_com_bill_address[]" class="form-control bill_address">{{ $address->address ?? '' }}</textarea>
                                                    </div>
                                                </div>

                                                <input type="hidden" name="edit_com_bill_zone[]" class="zone" value="{{ $address->zone ?? '' }}">
            ...
            <div class="modal-footer">
                <button type="button" class="btn me-auto" data-bs-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-primary" id="edit_commercial_customer_form_btn">Save
                    changes</button>
            </div>
        </div>
    </form>
...
<script type="text/javascript">
    ...
    function res_add_row_contact(el)
    {
        var newRow = `<div class="row mt-3">
                        <div class="col-lg-5 col-md-5 col-sm-12">
                            <div class="mb-3">
                                <label class="form-label">Contact Name</label>
                                <input type="text" class="form-control" name="edit_res_additional_contact_name[]" placeholder="Enter Name">
                            </div>
                        </div>
                        <div class="col-lg-5 col-md-5 col-sm-12">
                            <div class="mb-3">
                                <label class="form-label">Mobile Number</label>
                                <input type="text" class="form-control" name="edit_res_additional_mobile_number[]" placeholder="Enter Number">
                            </div>
                        </div>
                        <div class="col-lg-5 col-md-5 col-sm-12">
                            <div class="mb-3">
                                <label class="form-label">Email</label>
                                <input type="email" class="form-control"
                                    name="edit_res_additional_email[]" placeholder="Enter Email">
                            </div>
                        </div> 
                        <div class="col-lg-2">
                            <label class="form-label" style="visibility: hidden;">Add</label>
        ...
        $('#edit-res-additional-rows').append(newRow);
    }
    ...
    function com_add_row_contact(el)
    {
        var newRow = `<div class="row mt-3">
                        <div class="col-lg-5 col-md-5 col-sm-12">
                            <div class="mb-3">
                                <label class="form-label">Contact Name</label>
                                <input type="text" class="form-control" name="edit_com_additional_contact_name[]" placeholder="Enter Name">
                            </div>
                        </div>
                        <div class="col-lg-5 col-md-5 col-sm-12">
                            <div class="mb-3">
                                <label class="form-label">Mobile Number</label>
                                <input type="text" class="form-control" name="edit_com_additional_mobile_no[]" placeholder="Enter Number">
                            </div>
                        </div>
                        <div class="col-lg-5 col-md-5 col-sm-12">
                            <div class="mb-3">
                                <label class="form-label">Email</label>
                                <input type="email" class="form-control"
                                    name="edit_com_additional_email[]" placeholder="Enter Email">
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <label class="form-label" style="visibility: hidden;">Add</label>
        ...
        $('#edit-com-additional-rows').append(newRow);
    }

    // crm edit start

    $("#edit_residential_customer_form_btn").click(function(e) {
        e.preventDefault();
    ...
    $("#edit_commercial_customer_form_btn").click(function(e) {           
        e.preventDefault();
    ...
    $('#edit_res_customer_name').blur(function(){

        var res_customer_name = $(this).val();
        $("#edit_res_serv_addr_pi_name").val(res_customer_name);
        $("#edit_res_bill_addr_pi_name").val(res_customer_name);

    });

    $('#edit_res_contact_no').blur(function(){

        var res_contact_no = $(this).val();
        $("#edit_res_serv_addr_pi_no").val(res_contact_no);
        $("#edit_res_bill_addr_pi_no").val(res_contact_no);

    });

    $('#edit_res_email').blur(function(){

        var res_email = $(this).val();
        $("#edit_res_serv_addr_pi_email").val(res_email);
        $("#edit_res_bill_addr_pi_email").val(res_email);

    });

    // customer name, contact number and email should be auto copy to service address and billing address (commercial)

    $('#edit_com_customer_name').blur(function(){

        var com_customer_name = $(this).val();
        $("#edit_com_serv_addr_pi_name").val(com_customer_name);
        $("#edit_com_bill_addr_pi_name").val(com_customer_name);
        $("#edit_comp_info_contact_name").val(com_customer_name);

    });

    $('#edit_com_contact_no').blur(function(){

        var com_contact_no = $(this).val();
        $("#edit_com_serv_addr_pi_no").val(com_contact_no);
        $("#edit_com_bill_addr_pi_no").val(com_contact_no);
        $("#edit_comp_info_company_mobile_no").val(com_contact_no);

    });

    $('#edit_com_email').blur(function(){

        var com_email = $(this).val();
        $("#edit_com_serv_addr_pi_email").val(com_email);
        $("#edit_com_bill_addr_pi_email").val(com_email);
        $("#edit_comp_info_company_email").val(com_email);
