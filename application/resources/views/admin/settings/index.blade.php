...
@section('content')
                ...
                <div class="card">
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a href="#type_of_services_tab" class="nav-link" data-bs-toggle="tab" aria-selected="false"
                                    tabindex="-1" role="tab">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-tool" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                        ...
                        <div class="tab-content">
                                            ...
                                            <div id="one" class="tabcontent">
                                                <div class="card-body">
                                                    ...
                                                    <div class="add-form my-3">
                                                        <form id="salutation-form" method="POST"
                                                    ...
                                                    <div class="add-form-table">
                                                        <div class="table-responsive">
                                                            <table id="salutation-table"
                                                                class="table card-table table-vcenter text-left text-nowrap datatable data-table">
                                                                <thead>
                                                                    <th>Name</th>
                                                                    <th>Status</th>
                                                                    ...
                                                                    @foreach ($salutation_data as $key => $value)
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                @if ($value->status == 1)
                                                                                    <span
                                                                                        class="badge bg-green">Active</span>
                                                                                @else
                                                                                    <span
                                                                                        class="badge bg-red">Deactive</span>
                                                                                @endif
                                                                            </td>
                                                                            <td>
                                                                                {{-- <i
                                                                                class='fa-solid fa-eye cursor-pointer me-2 text-blue btn-edit'></i> --}}
                                                                                <i class='btn btn-primary fa-solid fa-pencil cursor-pointer me-2 text-white btn-edit'
                                                                                    data-id="{{ $value->id }}"></i>

                                                                                <i class='btn btn-danger fa-solid cursor-pointer fa-trash me-2 text-white btn-delete'
                                                                                    data-id="{{ $value->id }}"></i>
                                                                            </td>
                                                                        </tr>
                                                                    @endforeach
                            ...
                            <div class="tab-pane" id="zone-settings" role="tabpanel">
                                ...
                                <div class="add-zone-table">
                                    <div class="table-responsive">
                                        <table id="zone-table"
                                            class="table card-table table-vcenter text-left text-nowrap datatable zone-table">
                                            <thead>
                                                <th>Zone Name</th>
                                                ...
                                                @foreach ($zone_data as $key => $zone)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="#" class="btn btn-edit_crm btn btn-primary"
                                                                onclick="edit_zone_modal('{{ $zone->id }}')">
                                                                <i class="fa fa-pencil" aria-hidden="true"></i></i>
                                                            </a>

                                                            <a href="#" class="btn-delete-zone btn btn-danger"
                                                                data-id="{{ $zone->id }}">
                                                ...
                                                @foreach ($paymentMethod as $key => $payment)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="#" class="btn btn-edit_crm btn btn-primary"
                                                                onclick="edit_payment_modal('{{ $payment->id }}')">
                                    ...
                                    <div class="row g-0">
                                        <div class="col-md-12">
                                            <div class="card-body">
                                                ...
                                                <div class="add-form my-3">
                                                    <form id="tax_form" data-table-id="tax-table" method="POST"
                                                        action="{{ route('setting.tax-store') }}">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="mb-3">
                                                                ...
                                                                <tbody>
                                                                    @foreach ($sourceData as $key => $value)
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <i class='btn btn-primary fa-solid fa-pencil cursor-pointer me-2 text-white btn-source-edit'
                                                                                    data-id="{{ $value->id }}"></i>

                                                                                <i class='btn btn-danger fa-solid cursor-pointer fa-trash me-2 text-white btn-source-delete'
                                                                                    data-id="{{ $value->id }}"></i>
                                                                            </td>
                                                                        </tr>
                                                                    @endforeach
                            ...
                            <div class="tab-pane" id="type_of_services_tab" role="tabpanel">
                                <div class="card">                                   
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col">
                                        ...
                                        <div class="col-auto ms-auto d-print-none">
                                            <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_service_type_modal">
                                                <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="type_of_services_table"
                                                class="table card-table table-vcenter text-left text-nowrap datatable data-table"
                                                style="width: 100%;">
                                                <thead>
                                                    <th>S/N</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="add-zone my-3">
                        <form id="zone_form" method="post" name="zone_form"
                            action="{{ route('zonesettings.store') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-5">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="zone_number[]" id="zone_number"
                                            class="form-control zoneNumber" value="" placeholder="380004"
                                            required="" style="width: 250px; min-height: 36px; height: 17px;"
                                            data-role="tagsinput">
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="mb-3">
                                        ...
                                        <input type="color" name="zone_color" id="zone_color"
                                            class="form-control form-control-color" value=""
    ...
    <div class="modal modal-blur fade" id="modal-payment" tabindex="-1" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="">
                        <form id="payment_method" method="post" name="payment_method"
                            action="{{ route('payment.method.store') }}">
                            @csrf
                            <div class="col-md-12">
                                <div class="mb-3">
    ...
    <div class="modal modal-blur fade" id="add_service_type_modal">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="add_service_type_form" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="col-md-12">
                            <div class="mb-3">
    ...
    <div class="modal modal-blur fade" id="edit_service_type_modal">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form id="edit_service_type_form" method="post">
                    @csrf

                    <input type="hidden" name="edit_service_type_id" id="edit_service_type_id">

                    <div class="modal-body">
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label">Type of Services:</label>
                                <input type="text" class="form-control" name="edit_service_type" id="edit_service_type" required>
                            </div>
                        </div>
...
@section('javascript')
                ...
                success: function(response) {
                    ...
                    if (response.message) {
                        ...
                        var html = `<tr>
                                        ...
                                        <td>                                                                      
                                            <i class="btn btn-primary fa-solid fa-pencil cursor-pointer me-2 text-white btn-edit" data-id="${response.salutation_id}"></i>
                                            <i class="btn btn-danger fa-solid cursor-pointer fa-trash me-2 text-white btn-delete" data-id="${response.salutation_id}"></i>
                                        </td>
                                    </tr>`;

                        $("#salutation-table tbody").append(html);
                        
                        // Append row to the table
                        // $(".data-table tbody").append("<tr data-name='" + name + "' data-email='" +
                        //     email + "'><td>" + name +
                        //     "</td><td>" + email +
                        ...
                        $("#salutation-form").find("input[name='name']").val('');
                    }
                },
                error: function(error) {
                ...
                success: function(response) {
                    if (response.message) {
                        ...
                        var html = `<tr>
                                        <td>${name}</td>
                                        <td>
                                            <i class="btn btn-primary fa-solid fa-pencil cursor-pointer me-2 text-white btn-source-edit" data-id="${response.source_id}"></i>
                                            <i class="btn btn-danger fa-solid cursor-pointer fa-trash me-2 text-white btn-source-delete" data-id="${response.source_id}"></i>
                                        </td>
                                    </tr>`;

                        // $("#source-table tbody").append("<tr data-name='" + name + "'><td>" + name +
                        ...
                        $("#source-form").find("input[name='source_name']").val('');
                    }
                },
                error: function(error) {
                    if (error.responseJSON && error.responseJSON.errors && error.responseJSON.errors
    ...
    <script>
        $(document).ready(function() {
            ...
            var service_type_table = $('#type_of_services_table').DataTable({
                "lengthChange": false,
                "pageLength": 10,
                ajax: {
                    url: "{{ route('setting.get-service-type-table-data') }}",
                    type: 'GET'
                }
            });
            ...
            $('body').on('submit', '#add_service_type_form', function(e){

                e.preventDefault();

                $.ajax({
                    type: "post",
                    url: "{{route('setting.service-type.store')}}",
                    data: $(this).serialize(),
                    success: function (result) {
                        console.log(result);
                        ...
                        {                    
                            ...
                            $("#add_service_type_modal").modal('hide');
                            $("#add_service_type_form")[0].reset();
                            service_type_table.ajax.reload();
                        }
                        else
                        {
                            iziToast.error({
            ...
            $('body').on('click', '.btn_service_type_edit', function() {

                var service_type_id = $(this).data('id');

                $.ajax({
                    type: 'get',
                    url: "{{ route('setting.service-type.edit') }}",
                    data: {
                    ...
                    success: function(result) {
                        ...
                        $("#edit_service_type_id").val(result.service_type.id);
                        $("#edit_service_type").val(result.service_type.service_type);
            ...
            $('body').on('submit', '#edit_service_type_form', function(e) {

                e.preventDefault();

                $.ajax({
                    type: "post",
                    url: "{{ route('setting.service-type.update') }}",
                    data: $(this).serialize(),
                    success: function(result) {
                        console.log(result);
                        ...
                        if (result.status == "error") {
                            ...
                            service_type_table.ajax.reload();
                            $("#edit_service_type_form")[0].reset();
                            $("#edit_service_type_modal").modal('hide');
                        } else {
                            iziToast.error({
                                message: result.message,
                                position: 'topRight',
            ...
            $('body').on('click', '.btn_service_type_delete', function() {

                var service_type_id = $(this).data('id');

                $.ajax({
                    type: 'get',
                    url: "{{ route('setting.service-type.delete') }}",
                    data: {
                        "service_type_id": service_type_id,
                    },
                    success: function(result) {
