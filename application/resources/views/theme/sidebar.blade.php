 <aside class="navbar navbar-vertical navbar-expand-lg navbar-dark d-print-none" style="width: 12rem;">
     <div class="container-fluid">
         ...
         <h1 class="navbar-brand navbar-brand-autodark">
             <a href="#">
                 <img src="{{ asset('public/theme/dist/img/logo-white.png') }}" width="110" height="32"
                     alt="Absolute"" class=" navbar-brand-image">
             </a>
         </h1>
             ...
             <ul class="navbar-nav pt-lg-3">
                 ...
                 <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{ route('payment.index') }}" style="color:azure">
                            Payment
                        </a>
                        
                        <a class="dropdown-item" href="{{ route('payment-approve.index') }}" style="color:azure">
                            Payment Approval
                        </a>

                        <a class="dropdown-item" href="{{ route('payment-history.index') }}" style="color:azure">
                            Payment History
                        </a>
                        {{-- <a class="dropdown-item" href="{{ route('all-payments') }}" style="color:azure">
                            All Payment Details
                        </a> --}}
                    </div>
                 </li>
              ...
              <a class="nav-link dropdown-toggle" href="#navbar-help" data-bs-toggle="dropdown"
                ...
                <span
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-lock-check" width="24"
              ...
              <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="Authentication/forgot-password.html" target="_blank" rel="noopener">
                  Forgot password
                </a>
                 ...
                 <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu">
                         <a class="dropdown-item" href="{{ route('territory') }}" style="color:azure">
                             Territory
                         </a>
                         <a class="dropdown-item" href="{{ route('languageSpoken') }}" style="color:azure">
                             Language Spoken
                         </a>
                         <a class="dropdown-item" href="{{ route('paymentTerms') }}" style="color:azure">
                             Payment Terms
                         </a>
