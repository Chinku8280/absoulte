                ...
                <div class="row row-deck row-cards">
                    <div class="col-sm-6 col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="h1 mb-3">${{number_format($todays_total_amount, 2)}}</div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="subheader">This month Sales</div>
                                    {{-- <div class="ms-auto lh-1">
                                        <div class="dropdown">
                                            <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown"
                                                aria-haspopup="true" aria-expanded="false">Last 7 days</a>
                                ...
                                <div class="d-flex align-items-baseline">
                                    <div class="h1 mb-0 me-2">${{number_format($this_month_total_amount, 2)}}</div>
                                    {{-- <div class="me-auto">
                                        <span class="text-green d-inline-flex align-items-center lh-1">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-baseline">
                                    <div class="h1 mb-3 me-2">{{$total_customers}}</div>
                                    {{-- <div class="me-auto">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="subheader">Total Active customers</div>
                                    {{-- <div class="ms-auto lh-1">
                                        <div class="dropdown">
                                            <a class="dropdown-toggle text-muted" href="#"
                                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last
                                ...
                                <div class="d-flex align-items-baseline">
                                    <div class="h1 mb-3 me-2">{{$total_active_customers}}</div>
                                    {{-- <div class="me-auto">
                                        <span class="text-green d-inline-flex align-items-center lh-1">
                                ...
                                <div class="card card-sm">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <span
                                                    class="bg-instagram text-white avatar"><!-- Download SVG icon from http://tabler-icons.io/i/brand-twitter -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-title d-flex" style="justify-content: space-between;">
                                    ...
                                    <div class="form-group">
                                        <select name="chart_filter" id="chart_filter" class="form-control">
                                ...
                                <div id="sales_order_chart" class="chart-lg"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                                ...
                                <div class="ratio ratio-21x9">
                                    <div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table" id="pending_leads_table">
                                                <thead>
                                                    <tr>
                                                        <th>Sl.no.</th>
                                                        <th>Customer Name</th>
                                        ...
                                        <div class="divide-y">
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-auto">
                                                        <span class="avatar"
                                                            style="background-image: url(theme/static/avatars/001f.jpg)"></span>
                                                    </div>
                                                    <div class="col">
                                                        <div class="text-truncate">
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-auto">
                                                        <span class="avatar"
                                                            style="background-image: url(theme/static/avatars/002f.jpg)"></span>
                                                    </div>
                                                    <div class="col">
                                                        <div class="text-truncate">
                                                            <strong>Kellie Skingley</strong> closed a new deal on project
                                                            <strong>Pen Pineapple
                                                                Apple Pen</strong>.
                                                        </div>
                                                        <div class="text-muted">2 days ago</div>
                                                    </div>
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-auto">
                                                        <span class="avatar"
                                                            style="background-image: url(theme/static/avatars/003f.jpg)"></span>
                                                    </div>
                                                    <div class="col">
                                                        <div class="text-truncate">
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-auto">
                                                        <span class="avatar"
                                                            style="background-image: url(theme/static/avatars/006m.jpg)"></span>
                                                    </div>
                                                    <div class="col">
                                                        <div class="text-truncate">
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-auto">
                                                        <span class="avatar"
                                                            style="background-image: url(theme/static/avatars/004f.jpg)"></span>
                                                    </div>
                                                    <div class="col">
                                                        <div class="text-truncate">
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-auto">
                                                        <span class="avatar"
                                                            style="background-image: url(theme/static/avatars/007m.jpg)"></span>
                                                    </div>
                                                    <div class="col">
                                                        <div class="text-truncate">
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-auto">
                                                        <span class="avatar"
                                                            style="background-image: url(theme/static/avatars/009m.jpg)"></span>
                                                    </div>
                                                    <div class="col">
                                                        <div class="text-truncate">
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-auto">
                                                        <span class="avatar"
                                                            style="background-image: url(theme/static/avatars/010m.jpg)"></span>
                                                    </div>
                                                    <div class="col">
                                                        <div class="text-truncate">
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-auto">
                                                        <span class="avatar"
                                                            style="background-image: url(theme/static/avatars/005f.jpg)"></span>
                                                    </div>
                                                    <div class="col">
                                                        <div class="text-truncate">
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-auto">
                                                        <span class="avatar"
                                                            style="background-image: url(theme/static/avatars/006f.jpg)"></span>
                                                    </div>
                                                    <div class="col">
                                                        <div class="text-truncate">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-10">
                                        ...
                                        <div class="markdown text-muted">
                                            ...
                                            download any of the 3222 icons in SVG, PNG or&nbsp;React and use them in your
                                            favourite design
                                            tools.
                                        </div>
                                        <div class="mt-3">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="https://github.com/sponsors/codecalm" class="card card-sponsor" target="_blank"
                            rel="noopener" style="background-image: url(theme/static/sponsor-banner-homepage.svg)"
...
@section('javascript')
    <script>
        ...
        function get_chart_data()
        {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    create_chart(result.data, result.key);
                },
        ...
        function create_chart(sales_data, key)
        {
            var options = {
                chart: {
                    type: "bar",
            ...
            chart = new ApexCharts(
                document.querySelector("#sales_order_chart"),
                options
            );
